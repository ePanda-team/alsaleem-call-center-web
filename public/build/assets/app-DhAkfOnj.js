 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yu=dm;function Zu(n,t={}){let e=n;typeof t!="object"&&(t={name:t});const r={name:wi,automaticDataCollectionEnabled:!0,...t},s=r.name;if(typeof s!="string"||!s)throw Ee.create("bad-app-name",{appName:String(s)});if(e||(e=qu()),!e)throw Ee.create("no-options");const o=Yr.get(s);if(o){if(Jr(e,o.options)&&Jr(r,o.config))return o;throw Ee.create("duplicate-app",{appName:s})}const a=new Ap(s);for(const h of Ai.values())a.addComponent(h);const u=new gm(e,r,a);return Yr.set(s,u),u}function tl(n=wi){const t=Yr.get(n);if(!t&&n===wi&&qu())return Zu();if(!t)throw Ee.create("no-app",{appName:n});return t}function Te(n,t,e){let r=fm[n]??n;e&&(r+=`-${e}`);const s=r.match(/\s|\//),o=t.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${t}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),ae.warn(a.join(" "));return}Zn(new ln(`${r}-version`,()=>({library:r,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _m="firebase-heartbeat-database",ym=1,tr="firebase-heartbeat-store";let ii=null;function el(){return ii||(ii=xp(_m,ym,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(tr)}catch(e){console.warn(e)}}}}).catch(n=>{throw Ee.create("idb-open",{originalErrorMessage:n.message})})),ii}async function Em(n){try{const e=(await el()).transaction(tr),r=await e.objectStore(tr).get(nl(n));return await e.done,r}catch(t){if(t instanceof We)ae.warn(t.message);else{const e=Ee.create("idb-get",{originalErrorMessage:t?.message});ae.warn(e.message)}}}async function ic(n,t){try{const r=(await el()).transaction(tr,"readwrite");await r.objectStore(tr).put(t,nl(n)),await r.done}catch(e){if(e instanceof We)ae.warn(e.message);else{const r=Ee.create("idb-set",{originalErrorMessage:e?.message});ae.warn(r.message)}}}function nl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bm(n){Zn(new ln("platform-logger",t=>new Fp(t),"PRIVATE")),Zn(new ln("heartbeat",t=>new Am(t),"PRIVATE")),Te(Ti,rc,n),Te(Ti,rc,"esm2020"),Te("fire-js","")}bm("");var Sm="firebase",Cm="12.3.0";/**
 * @license
...
*/var sl,$n,il,$r,Ii,ol,al,cl;(function(){var n,t=Object.defineProperty;function e(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof kr=="object"&&kr];for(var c=0;c<i.length;++c){var l=i[c];if(l&&l.Math==Math)return l}throw Error("Cannot find global object")}var r=e(this);function s(i,c){if(c)t:{var l=r;i=i.split(".");for(var p=0;p<i.length-1;p++){var R=i[p];if(!(R in l))break t;l=l[R]}i=i[i.length-1],p=l[i],c=c(p),c!=p&&c!=null&&t(l,i,{configurable:!0,writable:!0,value:c})}}s("Symbol.dispose",function(i){return i||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(i){return i||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(i){return i||function(c){var l=[],p;for(p in c)Object.prototype.hasOwnProperty.call(c,p)&&l.push([p,c[p]]);return l}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function u(i){var c=typeof i;return c=="object"&&i!=null||c=="function"}function h(i,c,l){return i.call.apply(i.bind,arguments)}function d(i,c,l){return d=h,d.apply(null,arguments)}function f(i,c){var l=Array.prototype.slice.call(arguments,1);return function(){var p=l.slice();return p.push.apply(p,arguments),i.apply(this,p)}}function g(i,c){function l(){}l.prototype=c.prototype,i.Z=c.prototype,i.prototype=new l,i.prototype.constructor=i,i.Ob=function(p,R,C){for(var k=Array(arguments.length-2),W=2;W<arguments.length;W++)k[W-2]=arguments[W];return c.prototype[R].apply(p,k)}}var w=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?i=>i&&AsyncContext.Snapshot.wrap(i):i=>i;function P(i){const c=i.length;if(c>0){const l=Array(c);for(let p=0;p<c;p++)l[p]=i[p];return l}return[]}function v(i,c){for(let p=1;p<arguments.length;p++){const R=arguments[p];var l=typeof R;if(l=l!="object"?l:R?Array.isArray(R)?"array":l:"null",l=="array"||l=="object"&&typeof R.length=="number"){l=i.length||0;const C=R.length||0;i.length=l+C;for(let k=0;k<C;k++)i[l+k]=R[k]}else i.push(R)}}class V{constructor(c,l){this.i=c,this.j=l,this.h=0,this.g=null}get(){let c;return this.h>0?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function b(i){a.setTimeout(()=>{throw i},0)}function x(){var i=E;let c=null;return i.g&&(c=i.g,i.g=i.g.next,i.g||(i.h=null),c.next=null),c}class F{constructor(){this.h=this.g=null}add(c,l){const p=L.get();p.set(c,l),this.h?this.h.next=p:this.g=p,this.h=p}}var L=new V(()=>new j,i=>i.reset());class j{constructor(){this.next=this.g=this.h=null}set(c,l){this.h=c,this.g=l,this.next=null}reset(){this.next=this.g=this.h=null}}let J,tt=!1,E=new F,_=()=>{const i=Promise.resolve(void 0);J=()=>{i.then(y)}};function y(){for(var i;i=x();){try{i.h.call(i.g)}catch(l){b(l)}var c=L;c.j(i),c.h<100&&(c.h++,i.next=c.g,c.g=i)}tt=!1}function A(){this.u=this.u,this.C=this.C}A.prototype.u=!1,A.prototype.dispose=function(){this.u||(this.u=!0,this.N())},A.prototype[Symbol.dispose]=function(){this.dispose()},A.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function T(i,c){this.type=i,this.g=this.target=c,this.defaultPrevented=!1}T.prototype.h=function(){this.defaultPrevented=!0};var I=(function(){if(!a.addEventListener||!Object.defineProperty)return!1;var i=!1,c=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const l=()=>{};a.addEventListener("test",l,c),a.removeEventListener("test",l,c)}catch{}return i})();function m(i){return/^[\s\xa0]*$/.test(i)}function $(i,c){T.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i&&this.init(i,c)}g($,T),$.prototype.init=function(i,c){const l=this.type=i.type,p=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;this.target=i.target||i.srcElement,this.g=c,c=i.relatedTarget,c||(l=="mouseover"?c=i.fromElement:l=="mouseout"&&(c=i.toElement)),this.relatedTarget=c,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=i.pointerType,this.state=i.state,this.i=i,i.defaultPrevented&&$.Z.h.call(this)},$.prototype.h=function(){$.Z.h.call(this);const i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var B="closure_listenable_"+(Math.random()*1e6|0),K=0;function wt(i,c,l,p,R){this.listener=i,this.proxy=null,this.src=c,this.type=l,this.capture=!!p,this.ha=R,this.key=++K,this.da=this.fa=!1}function nt(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function it(i,c,l){for(const p in i)c.call(l,i[p],p,i)}function oe(i,c){for(const l in i)c.call(void 0,i[l],l,i)}function yt(i){const c={};for(const l in i)c[l]=i[l];return c}const xt="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Qt(i,c){let l,p;for(let R=1;R<arguments.length;R++){p=arguments[R];for(l in p)i[l]=p[l];for(let C=0;C<xt.length;C++)l=xt[C],Object.prototype.hasOwnProperty.call(p,l)&&(i[l]=p[l])}}function Ht(i){this.src=i,this.g={},this.h=0}Ht.prototype.add=function(i,c,l,p,R){const C=i.toString();i=this.g[C],i||(i=this.g[C]=[],this.h++);const k=Vs(i,c,p,R);return k>-1?(c=i[k],l||(c.fa=!1)):(c=new wt(c,this.src,C,!!p,R),c.fa=l,i.push(c)),c};function Ye(i,c){const l=c.type;if(l in i.g){var p=i.g[l],R=Array.prototype.indexOf.call(p,c,void 0),C;(C=R>=0)&&Array.prototype.splice.call(p,R,1),C&&(nt(c),i.g[l].length==0&&(delete i.g[l],i.h--))}}function Vs(i,c,l,p){for(let R=0;R<i.length;++R){const C=i[R];if(!C.da&&C.listener==c&&C.capture==!!l&&C.ha==p)return R}return-1}var Ds="closure_lm_"+(Math.random()*1e6|0),Ns={};function Lo(i,c,l,p,R){if(Array.isArray(c)){for(let C=0;C<c.length;C++)Lo(i,c[C],l,p,R);return null}return l=Bo(l),i&&i[B]?i.J(c,l,u(p)?!!p.capture:!1,R):Wh(i,c,l,!1,p,R)}function Wh(i,c,l,p,R,C){if(!c)throw Error("Invalid event type");const k=u(R)?!!R.capture:!!R;let W=Os(i);if(W||(i[Ds]=W=new Ht(i)),l=W.add(c,l,p,k,C),l.proxy)return l;if(p=Qh(),l.proxy=p,p.src=i,p.listener=l,i.addEventListener)I||(R=k),R===void 0&&(R=!1),i.addEventListener(c.toString(),p,R);else if(i.attachEvent)i.attachEvent(Uo(c.toString()),p);else if(i.addListener&&i.removeListener)i.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return l}function Qh(){function i(l){return c.call(i.src,i.listener,l)}const c=Xh;return i}function Fo(i,c,l,p,R){if(Array.isArray(c))for(var C=0;C<c.length;C++)Fo(i,c[C],l,p,R);else p=u(p)?!!p.capture:!!p,l=Bo(l),i&&i[B]?(i=i.i,C=String(c).toString(),C in i.g&&(c=i.g[C],l=Vs(c,l,p,R),l>-1&&(nt(c[l]),Array.prototype.splice.call(c,l,1),c.length==0&&(delete i.g[C],i.h--)))):i&&(i=Os(i))&&(c=i.g[c.toString()],i=-1,c&&(i=Vs(c,l,p,R)),(l=i>-1?c[i]:null)&&ks(l))}function ks(i){if(typeof i!="number"&&i&&!i.da){var c=i.src;if(c&&c[B])Ye(c.i,i);else{var l=i.type,p=i.proxy;c.removeEventListener?c.removeEventListener(l,p,i.capture):c.detachEvent?c.detachEvent(Uo(l),p):c.addListener&&c.removeListener&&c.removeListener(p),(l=Os(c))?(Ye(l,i),l.h==0&&(l.src=null,c[Ds]=null)):nt(i)}}}function Uo(i){return i in Ns?Ns[i]:Ns[i]="on"+i}function Xh(i,c){if(i.da)i=!0;else{c=new $(c,this);const l=i.listener,p=i.ha||i.src;i.fa&&ks(i),i=l.call(p,c)}return i}function Os(i){return i=i[Ds],i instanceof Ht?i:null}var xs="__closure_events_fn_"+(Math.random()*1e9>>>0);function Bo(i){return typeof i=="function"?i:(i[xs]||(i[xs]=function(c){return i.handleEvent(c)}),i[xs])}function St(){A.call(this),this.i=new Ht(this),this.M=this,this.G=null}g(St,A),St.prototype[B]=!0,St.prototype.removeEventListener=function(i,c,l,p){Fo(this,i,c,l,p)};function Nt(i,c){var l,p=i.G;if(p)for(l=[];p;p=p.G)l.push(p);if(i=i.M,p=c.type||c,typeof c=="string")c=new T(c,i);else if(c instanceof T)c.target=c.target||i;else{var R=c;c=new T(p,i),Qt(c,R)}R=!0;let C,k;if(l)for(k=l.length-1;k>=0;k--)C=c.g=l[k],R=Tr(C,p,!0,c)&&R;if(C=c.g=i,R=Tr(C,p,!0,c)&&R,R=Tr(C,p,!1,c)&&R,l)for(k=0;k<l.length;k++)C=c.g=l[k],R=Tr(C,p,!1,c)&&R}St.prototype.N=function(){if(St.Z.N.call(this),this.i){var i=this.i;for(const c in i.g){const l=i.g[c];for(let p=0;p<l.length;p++)nt(l[p]);delete i.g[c],i.h--}}this.G=null},St.prototype.J=function(i,c,l,p){return this.i.add(String(i),c,!1,l,p)},St.prototype.K=function(i,c,l,p){return this.i.add(String(i),c,!0,l,p)};function Tr(i,c,l,p){if(c=i.i.g[String(c)],!c)return!0;c=c.concat();let R=!0;for(let C=0;C<c.length;++C){const k=c[C];if(k&&!k.da&&k.capture==l){const W=k.listener,Et=k.ha||k.src;k.fa&&Ye(i.i,k),R=W.call(Et,p)!==!1&&R}}return R&&!p.defaultPrevented}function Jh(i,c){if(typeof i!="function")if(i&&typeof i.handleEvent=="function")i=d(i.handleEvent,i);else throw Error("Invalid listener argument");return Number(c)>2147483647?-1:a.setTimeout(i,c||0)}function jo(i){i.g=Jh(()=>{i.g=null,i.i&&(i.i=!1,jo(i))},i.l);const c=i.h;i.h=null,i.m.apply(null,c)}class Yh extends A{constructor(c,l){super(),this.m=c,this.l=l,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:jo(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Rn(i){A.call(this),this.h=i,this.g={}}g(Rn,A);var qo=[];function $o(i){it(i.g,function(c,l){this.g.hasOwnProperty(l)&&ks(c)},i),i.g={}}Rn.prototype.N=function(){Rn.Z.N.call(this),$o(this)},Rn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Ms=a.JSON.stringify,Zh=a.JSON.parse,td=class{stringify(i){return a.JSON.stringify(i,void 0)}parse(i){return a.JSON.parse(i,void 0)}};function zo(){}function Ho(){}var bn={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Ls(){T.call(this,"d")}g(Ls,T);function Fs(){T.call(this,"c")}g(Fs,T);var Ne={},Go=null;function wr(){return Go=Go||new St}Ne.Ia="serverreachability";function Ko(i){T.call(this,Ne.Ia,i)}g(Ko,T);function Sn(i){const c=wr();Nt(c,new Ko(c))}Ne.STAT_EVENT="statevent";function Wo(i,c){T.call(this,Ne.STAT_EVENT,i),this.stat=c}g(Wo,T);function kt(i){const c=wr();Nt(c,new Wo(c,i))}Ne.Ja="timingevent";function Qo(i,c){T.call(this,Ne.Ja,i),this.size=c}g(Qo,T);function Cn(i,c){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){i()},c)}function Pn(){this.g=!0}Pn.prototype.ua=function(){this.g=!1};function ed(i,c,l,p,R,C){i.info(function(){if(i.g)if(C){var k="",W=C.split("&");for(let rt=0;rt<W.length;rt++){var Et=W[rt].split("=");if(Et.length>1){const At=Et[0];Et=Et[1];const Jt=At.split("_");k=Jt.length>=2&&Jt[1]=="type"?k+(At+"="+Et+"&"):k+(At+"=redacted&")}}}else k=null;else k=C;return"XMLHTTP REQ ("+p+") [attempt "+R+"]: "+c+`
`+l+`
`+k})}function nd(i,c,l,p,R,C,k){i.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+R+"]: "+c+`
`+l+`
`+C+" "+k})}function Ze(i,c,l,p){i.info(function(){return"XMLHTTP TEXT ("+c+"): "+sd(i,l)+(p?" "+p:"")})}function rd(i,c){i.info(function(){return"TIMEOUT: "+c})}Pn.prototype.info=function(){};function sd(i,c){if(!i.g)return c;if(!c)return null;try{const C=JSON.parse(c);if(C){for(i=0;i<C.length;i++)if(Array.isArray(C[i])){var l=C[i];if(!(l.length<2)){var p=l[1];if(Array.isArray(p)&&!(p.length<1)){var R=p[0];if(R!="noop"&&R!="stop"&&R!="close")for(let k=1;k<p.length;k++)p[k]=""}}}}return Ms(C)}catch{return c}}var Ar={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Xo={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Jo;function Us(){}g(Us,zo),Us.prototype.g=function(){return new XMLHttpRequest},Jo=new Us;function Vn(i){return encodeURIComponent(String(i))}function id(i){var c=1;i=i.split(":");const l=[];for(;c>0&&i.length;)l.push(i.shift()),c--;return i.length&&l.push(i.join(":")),l}function le(i,c,l,p){this.j=i,this.i=c,this.l=l,this.S=p||1,this.V=new Rn(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Yo}function Yo(){this.i=null,this.g="",this.h=!1}var Zo={},Bs={};function js(i,c,l){i.M=1,i.A=vr(Xt(c)),i.u=l,i.R=!0,ta(i,null)}function ta(i,c){i.F=Date.now(),Ir(i),i.B=Xt(i.A);var l=i.B,p=i.S;Array.isArray(p)||(p=[String(p)]),fa(l.i,"t",p),i.C=0,l=i.j.L,i.h=new Yo,i.g=Da(i.j,l?c:null,!i.u),i.P>0&&(i.O=new Yh(d(i.Y,i,i.g),i.P)),c=i.V,l=i.g,p=i.ba;var R="readystatechange";Array.isArray(R)||(R&&(qo[0]=R.toString()),R=qo);for(let C=0;C<R.length;C++){const k=Lo(l,R[C],p||c.handleEvent,!1,c.h||c);if(!k)break;c.g[k.key]=k}c=i.J?yt(i.J):{},i.u?(i.v||(i.v="POST"),c["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.B,i.v,i.u,c)):(i.v="GET",i.g.ea(i.B,i.v,null,c)),Sn(),ed(i.i,i.v,i.B,i.l,i.S,i.u)}le.prototype.ba=function(i){i=i.target;const c=this.O;c&&fe(i)==3?c.j():this.Y(i)},le.prototype.Y=function(i){try{if(i==this.g)t:{const W=fe(this.g),Et=this.g.ya(),rt=this.g.ca();if(!(W<3)&&(W!=3||this.g&&(this.h.h||this.g.la()||Ta(this.g)))){this.K||W!=4||Et==7||(Et==8||rt<=0?Sn(3):Sn(2)),qs(this);var c=this.g.ca();this.X=c;var l=od(this);if(this.o=c==200,nd(this.i,this.v,this.B,this.l,this.S,W,c),this.o){if(this.U&&!this.L){e:{if(this.g){var p,R=this.g;if((p=R.g?R.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!m(p)){var C=p;break e}}C=null}if(i=C)Ze(this.i,this.l,i,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,$s(this,i);else{this.o=!1,this.m=3,kt(12),ke(this),Dn(this);break t}}if(this.R){i=!0;let At;for(;!this.K&&this.C<l.length;)if(At=ad(this,l),At==Bs){W==4&&(this.m=4,kt(14),i=!1),Ze(this.i,this.l,null,"[Incomplete Response]");break}else if(At==Zo){this.m=4,kt(15),Ze(this.i,this.l,l,"[Invalid Chunk]"),i=!1;break}else Ze(this.i,this.l,At,null),$s(this,At);if(ea(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),W!=4||l.length!=0||this.h.h||(this.m=1,kt(16),i=!1),this.o=this.o&&i,!i)Ze(this.i,this.l,l,"[Invalid Chunked Response]"),ke(this),Dn(this);else if(l.length>0&&!this.W){this.W=!0;var k=this.j;k.g==this&&k.aa&&!k.P&&(k.j.info("Great, no buffering proxy detected. Bytes received: "+l.length),Js(k),k.P=!0,kt(11))}}else Ze(this.i,this.l,l,null),$s(this,l);W==4&&ke(this),this.o&&!this.K&&(W==4?Sa(this.j,this):(this.o=!1,Ir(this)))}else wd(this.g),c==400&&l.indexOf("Unknown SID")>0?(this.m=3,kt(12)):(this.m=0,kt(13)),ke(this),Dn(this)}}}catch{}finally{}};function od(i){if(!ea(i))return i.g.la();const c=Ta(i.g);if(c==="")return"";let l="";const p=c.length,R=fe(i.g)==4;if(!i.h.i){if(typeof TextDecoder>"u")return ke(i),Dn(i),"";i.h.i=new a.TextDecoder}for(let C=0;C<p;C++)i.h.h=!0,l+=i.h.i.decode(c[C],{stream:!(R&&C==p-1)});return c.length=0,i.h.g+=l,i.C=0,i.h.g}function ea(i){return i.g?i.v=="GET"&&i.M!=2&&i.j.Aa:!1}function ad(i,c){var l=i.C,p=c.indexOf(`
`,l);return p==-1?Bs:(l=Number(c.substring(l,p)),isNaN(l)?Zo:(p+=1,p+l>c.length?Bs:(c=c.slice(p,p+l),i.C=p+l,c)))}le.prototype.cancel=function(){this.K=!0,ke(this)};function Ir(i){i.T=Date.now()+i.H,na(i,i.H)}function na(i,c){if(i.D!=null)throw Error("WatchDog timer not null");i.D=Cn(d(i.aa,i),c)}function qs(i){i.D&&(a.clearTimeout(i.D),i.D=null)}le.prototype.aa=function(){this.D=null;const i=Date.now();i-this.T>=0?(rd(this.i,this.B),this.M!=2&&(Sn(),kt(17)),ke(this),this.m=2,Dn(this)):na(this,this.T-i)};function Dn(i){i.j.I==0||i.K||Sa(i.j,i)}function ke(i){qs(i);var c=i.O;c&&typeof c.dispose=="function"&&c.dispose(),i.O=null,$o(i.V),i.g&&(c=i.g,i.g=null,c.abort(),c.dispose())}function $s(i,c){try{var l=i.j;if(l.I!=0&&(l.g==i||zs(l.h,i))){if(!i.L&&zs(l.h,i)&&l.I==3){try{var p=l.Ba.g.parse(c)}catch{p=null}if(Array.isArray(p)&&p.length==3){var R=p;if(R[0]==0){t:if(!l.v){if(l.g)if(l.g.F+3e3<i.F)Pr(l),Sr(l);else break t;Xs(l),kt(18)}}else l.xa=R[1],0<l.xa-l.K&&R[2]<37500&&l.F&&l.A==0&&!l.C&&(l.C=Cn(d(l.Va,l),6e3));ia(l.h)<=1&&l.ta&&(l.ta=void 0)}else xe(l,11)}else if((i.L||l.g==i)&&Pr(l),!m(c))for(R=l.Ba.g.parse(c),c=0;c<R.length;c++){let rt=R[c];const At=rt[0];if(!(At<=l.K))if(l.K=At,rt=rt[1],l.I==2)if(rt[0]=="c"){l.M=rt[1],l.ba=rt[2];const Jt=rt[3];Jt!=null&&(l.ka=Jt,l.j.info("VER="+l.ka));const Me=rt[4];Me!=null&&(l.za=Me,l.j.info("SVER="+l.za));const pe=rt[5];pe!=null&&typeof pe=="number"&&pe>0&&(p=1.5*pe,l.O=p,l.j.info("backChannelRequestTimeoutMs_="+p)),p=l;const me=i.g;if(me){const Dr=me.g?me.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Dr){var C=p.h;C.g||Dr.indexOf("spdy")==-1&&Dr.indexOf("quic")==-1&&Dr.indexOf("h2")==-1||(C.j=C.l,C.g=new Set,C.h&&(Hs(C,C.h),C.h=null))}if(p.G){const Ys=me.g?me.g.getResponseHeader("X-HTTP-Session-Id"):null;Ys&&(p.wa=Ys,ot(p.J,p.G,Ys))}}l.I=3,l.l&&l.l.ra(),l.aa&&(l.T=Date.now()-i.F,l.j.info("Handshake RTT: "+l.T+"ms")),p=l;var k=i;if(p.na=Va(p,p.L?p.ba:null,p.W),k.L){oa(p.h,k);var W=k,Et=p.O;Et&&(W.H=Et),W.D&&(qs(W),Ir(W)),p.g=k}else Ra(p);l.i.length>0&&Cr(l)}else rt[0]!="stop"&&rt[0]!="close"||xe(l,7);else l.I==3&&(rt[0]=="stop"||rt[0]=="close"?rt[0]=="stop"?xe(l,7):Qs(l):rt[0]!="noop"&&l.l&&l.l.qa(rt),l.A=0)}}Sn(4)}catch{}}var cd=class{constructor(i,c){this.g=i,this.map=c}};function ra(i){this.l=i||10,a.PerformanceNavigationTiming?(i=a.performance.getEntriesByType("navigation"),i=i.length>0&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function sa(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function ia(i){return i.h?1:i.g?i.g.size:0}function zs(i,c){return i.h?i.h==c:i.g?i.g.has(c):!1}function Hs(i,c){i.g?i.g.add(c):i.h=c}function oa(i,c){i.h&&i.h==c?i.h=null:i.g&&i.g.has(c)&&i.g.delete(c)}ra.prototype.cancel=function(){if(this.i=aa(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function aa(i){if(i.h!=null)return i.i.concat(i.h.G);if(i.g!=null&&i.g.size!==0){let c=i.i;for(const l of i.g.values())c=c.concat(l.G);return c}return P(i.i)}var ca=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function ud(i,c){if(i){i=i.split("&");for(let l=0;l<i.length;l++){const p=i[l].indexOf("=");let R,C=null;p>=0?(R=i[l].substring(0,p),C=i[l].substring(p+1)):R=i[l],c(R,C?decodeURIComponent(C.replace(/\+/g," ")):"")}}}function he(i){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let c;i instanceof he?(this.l=i.l,Nn(this,i.j),this.o=i.o,this.g=i.g,kn(this,i.u),this.h=i.h,Gs(this,pa(i.i)),this.m=i.m):i&&(c=String(i).match(ca))?(this.l=!1,Nn(this,c[1]||"",!0),this.o=On(c[2]||""),this.g=On(c[3]||"",!0),kn(this,c[4]),this.h=On(c[5]||"",!0),Gs(this,c[6]||"",!0),this.m=On(c[7]||"")):(this.l=!1,this.i=new Mn(null,this.l))}he.prototype.toString=function(){const i=[];var c=this.j;c&&i.push(xn(c,ua,!0),":");var l=this.g;return(l||c=="file")&&(i.push("//"),(c=this.o)&&i.push(xn(c,ua,!0),"@"),i.push(Vn(l).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l=this.u,l!=null&&i.push(":",String(l))),(l=this.h)&&(this.g&&l.charAt(0)!="/"&&i.push("/"),i.push(xn(l,l.charAt(0)=="/"?dd:hd,!0))),(l=this.i.toString())&&i.push("?",l),(l=this.m)&&i.push("#",xn(l,pd)),i.join("")},he.prototype.resolve=function(i){const c=Xt(this);let l=!!i.j;l?Nn(c,i.j):l=!!i.o,l?c.o=i.o:l=!!i.g,l?c.g=i.g:l=i.u!=null;var p=i.h;if(l)kn(c,i.u);else if(l=!!i.h){if(p.charAt(0)!="/")if(this.g&&!this.h)p="/"+p;else{var R=c.h.lastIndexOf("/");R!=-1&&(p=c.h.slice(0,R+1)+p)}if(R=p,R==".."||R==".")p="";else if(R.indexOf("./")!=-1||R.indexOf("/.")!=-1){p=R.lastIndexOf("/",0)==0,R=R.split("/");const C=[];for(let k=0;k<R.length;){const W=R[k++];W=="."?p&&k==R.length&&C.push(""):W==".."?((C.length>1||C.length==1&&C[0]!="")&&C.pop(),p&&k==R.length&&C.push("")):(C.push(W),p=!0)}p=C.join("/")}else p=R}return l?c.h=p:l=i.i.toString()!=="",l?Gs(c,pa(i.i)):l=!!i.m,l&&(c.m=i.m),c};function Xt(i){return new he(i)}function Nn(i,c,l){i.j=l?On(c,!0):c,i.j&&(i.j=i.j.replace(/:$/,""))}function kn(i,c){if(c){if(c=Number(c),isNaN(c)||c<0)throw Error("Bad port number "+c);i.u=c}else i.u=null}function Gs(i,c,l){c instanceof Mn?(i.i=c,md(i.i,i.l)):(l||(c=xn(c,fd)),i.i=new Mn(c,i.l))}function ot(i,c,l){i.i.set(c,l)}function vr(i){return ot(i,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),i}function On(i,c){return i?c?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function xn(i,c,l){return typeof i=="string"?(i=encodeURI(i).replace(c,ld),l&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function ld(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var ua=/[#\/\?@]/g,hd=/[#\?:]/g,dd=/[#\?]/g,fd=/[#\?@]/g,pd=/#/g;function Mn(i,c){this.h=this.g=null,this.i=i||null,this.j=!!c}function Oe(i){i.g||(i.g=new Map,i.h=0,i.i&&ud(i.i,function(c,l){i.add(decodeURIComponent(c.replace(/\+/g," ")),l)}))}n=Mn.prototype,n.add=function(i,c){Oe(this),this.i=null,i=tn(this,i);let l=this.g.get(i);return l||this.g.set(i,l=[]),l.push(c),this.h+=1,this};function la(i,c){Oe(i),c=tn(i,c),i.g.has(c)&&(i.i=null,i.h-=i.g.get(c).length,i.g.delete(c))}function ha(i,c){return Oe(i),c=tn(i,c),i.g.has(c)}n.forEach=function(i,c){Oe(this),this.g.forEach(function(l,p){l.forEach(function(R){i.call(c,R,p,this)},this)},this)};function da(i,c){Oe(i);let l=[];if(typeof c=="string")ha(i,c)&&(l=l.concat(i.g.get(tn(i,c))));else for(i=Array.from(i.g.values()),c=0;c<i.length;c++)l=l.concat(i[c]);return l}n.set=function(i,c){return Oe(this),this.i=null,i=tn(this,i),ha(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[c]),this.h+=1,this},n.get=function(i,c){return i?(i=da(this,i),i.length>0?String(i[0]):c):c};function fa(i,c,l){la(i,c),l.length>0&&(i.i=null,i.g.set(tn(i,c),P(l)),i.h+=l.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],c=Array.from(this.g.keys());for(let p=0;p<c.length;p++){var l=c[p];const R=Vn(l);l=da(this,l);for(let C=0;C<l.length;C++){let k=R;l[C]!==""&&(k+="="+Vn(l[C])),i.push(k)}}return this.i=i.join("&")};function pa(i){const c=new Mn;return c.i=i.i,i.g&&(c.g=new Map(i.g),c.h=i.h),c}function tn(i,c){return c=String(c),i.j&&(c=c.toLowerCase()),c}function md(i,c){c&&!i.j&&(Oe(i),i.i=null,i.g.forEach(function(l,p){const R=p.toLowerCase();p!=R&&(la(this,p),fa(this,R,l))},i)),i.j=c}function gd(i,c){const l=new Pn;if(a.Image){const p=new Image;p.onload=f(de,l,"TestLoadImage: loaded",!0,c,p),p.onerror=f(de,l,"TestLoadImage: error",!1,c,p),p.onabort=f(de,l,"TestLoadImage: abort",!1,c,p),p.ontimeout=f(de,l,"TestLoadImage: timeout",!1,c,p),a.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=i}else c(!1)}function _d(i,c){const l=new Pn,p=new AbortController,R=setTimeout(()=>{p.abort(),de(l,"TestPingServer: timeout",!1,c)},1e4);fetch(i,{signal:p.signal}).then(C=>{clearTimeout(R),C.ok?de(l,"TestPingServer: ok",!0,c):de(l,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(R),de(l,"TestPingServer: error",!1,c)})}function de(i,c,l,p,R){try{R&&(R.onload=null,R.onerror=null,R.onabort=null,R.ontimeout=null),p(l)}catch{}}function yd(){this.g=new td}function Ks(i){this.i=i.Sb||null,this.h=i.ab||!1}g(Ks,zo),Ks.prototype.g=function(){return new Rr(this.i,this.h)};function Rr(i,c){St.call(this),this.H=i,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}g(Rr,St),n=Rr.prototype,n.open=function(i,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=i,this.D=c,this.readyState=1,Fn(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const c={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};i&&(c.body=i),(this.H||a).fetch(new Request(this.D,c)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Ln(this)),this.readyState=0},n.Pa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,Fn(this)),this.g&&(this.readyState=3,Fn(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;ma(this)}else i.text().then(this.Oa.bind(this),this.ga.bind(this))};function ma(i){i.j.read().then(i.Ma.bind(i)).catch(i.ga.bind(i))}n.Ma=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var c=i.value?i.value:new Uint8Array(0);(c=this.B.decode(c,{stream:!i.done}))&&(this.response=this.responseText+=c)}i.done?Ln(this):Fn(this),this.readyState==3&&ma(this)}},n.Oa=function(i){this.g&&(this.response=this.responseText=i,Ln(this))},n.Na=function(i){this.g&&(this.response=i,Ln(this))},n.ga=function(){this.g&&Ln(this)};function Ln(i){i.readyState=4,i.l=null,i.j=null,i.B=null,Fn(i)}n.setRequestHeader=function(i,c){this.A.append(i,c)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],c=this.h.entries();for(var l=c.next();!l.done;)l=l.value,i.push(l[0]+": "+l[1]),l=c.next();return i.join(`\r
...
`}),c}function Ws(i,c,l){t:{for(p in l){var p=!1;break t}p=!0}p||(l=ga(l),typeof i=="string"?l!=null&&Vn(l):ot(i,c,l))}function ut(i){St.call(this),this.headers=new Map,this.L=i||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}g(ut,St);var Ed=/^https?$/i,Td=["POST","PUT"];n=ut.prototype,n.Fa=function(i){this.H=i},n.ea=function(i,c,l,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+i);c=c?c.toUpperCase():"GET",this.D=i,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():Jo.g(),this.g.onreadystatechange=w(d(this.Ca,this));try{this.B=!0,this.g.open(c,String(i),!0),this.B=!1}catch(C){_a(this,C);return}if(i=l||"",l=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var R in p)l.set(R,p[R]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const C of p.keys())l.set(C,p.get(C));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(l.keys()).find(C=>C.toLowerCase()=="content-type"),R=a.FormData&&i instanceof a.FormData,!(Array.prototype.indexOf.call(Td,c,void 0)>=0)||p||R||l.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[C,k]of l)this.g.setRequestHeader(C,k);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(i),this.v=!1}catch(C){_a(this,C)}};function _a(i,c){i.h=!1,i.g&&(i.j=!0,i.g.abort(),i.j=!1),i.l=c,i.o=5,ya(i),br(i)}function ya(i){i.A||(i.A=!0,Nt(i,"complete"),Nt(i,"error"))}n.abort=function(i){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=i||7,Nt(this,"complete"),Nt(this,"abort"),br(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),br(this,!0)),ut.Z.N.call(this)},n.Ca=function(){this.u||(this.B||this.v||this.j?Ea(this):this.Xa())},n.Xa=function(){Ea(this)};function Ea(i){if(i.h&&typeof o<"u"){if(i.v&&fe(i)==4)setTimeout(i.Ca.bind(i),0);else if(Nt(i,"readystatechange"),fe(i)==4){i.h=!1;try{const C=i.ca();t:switch(C){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break t;default:c=!1}var l;if(!(l=c)){var p;if(p=C===0){let k=String(i.D).match(ca)[1]||null;!k&&a.self&&a.self.location&&(k=a.self.location.protocol.slice(0,-1)),p=!Ed.test(k?k.toLowerCase():"")}l=p}if(l)Nt(i,"complete"),Nt(i,"success");else{i.o=6;try{var R=fe(i)>2?i.g.statusText:""}catch{R=""}i.l=R+" ["+i.ca()+"]",ya(i)}}finally{br(i)}}}}function br(i,c){if(i.g){i.m&&(clearTimeout(i.m),i.m=null);const l=i.g;i.g=null,c||Nt(i,"ready");try{l.onreadystatechange=null}catch{}}}n.isActive=function(){return!!this.g};function fe(i){return i.g?i.g.readyState:0}n.ca=function(){try{return fe(this)>2?this.g.status:-1}catch{return-1}},n.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.La=function(i){if(this.g){var c=this.g.responseText;return i&&c.indexOf(i)==0&&(c=c.substring(i.length)),Zh(c)}};function Ta(i){try{if(!i.g)return null;if("response"in i.g)return i.g.response;switch(i.F){case"":case"text":return i.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in i.g)return i.g.mozResponseArrayBuffer}return null}catch{return null}}function wd(i){const c={};i=(i.g&&fe(i)>=2&&i.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<i.length;p++){if(m(i[p]))continue;var l=id(i[p]);const R=l[0];if(l=l[1],typeof l!="string")continue;l=l.trim();const C=c[R]||[];c[R]=C,C.push(l)}oe(c,function(p){return p.join(", ")})}n.ya=function(){return this.o},n.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Un(i,c,l){return l&&l.internalChannelParams&&l.internalChannelParams[i]||c}function wa(i){this.za=0,this.i=[],this.j=new Pn,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Un("failFast",!1,i),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Un("baseRetryDelayMs",5e3,i),this.Za=Un("retryDelaySeedMs",1e4,i),this.Ta=Un("forwardChannelMaxRetries",2,i),this.va=Un("forwardChannelRequestTimeoutMs",2e4,i),this.ma=i&&i.xmlHttpFactory||void 0,this.Ua=i&&i.Rb||void 0,this.Aa=i&&i.useFetchStreams||!1,this.O=void 0,this.L=i&&i.supportsCrossDomainXhr||!1,this.M="",this.h=new ra(i&&i.concurrentRequestLimit),this.Ba=new yd,this.S=i&&i.fastHandshake||!1,this.R=i&&i.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=i&&i.Pb||!1,i&&i.ua&&this.j.ua(),i&&i.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&i&&i.detectBufferingProxy||!1,this.ia=void 0,i&&i.longPollingTimeout&&i.longPollingTimeout>0&&(this.ia=i.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}n=wa.prototype,n.ka=8,n.I=1,n.connect=function(i,c,l,p){kt(0),this.W=i,this.H=c||{},l&&p!==void 0&&(this.H.OSID=l,this.H.OAID=p),this.F=this.X,this.J=Va(this,null,this.W),Cr(this)};function Qs(i){if(Aa(i),i.I==3){var c=i.V++,l=Xt(i.J);if(ot(l,"SID",i.M),ot(l,"RID",c),ot(l,"TYPE","terminate"),Bn(i,l),c=new le(i,i.j,c),c.M=2,c.A=vr(Xt(l)),l=!1,a.navigator&&a.navigator.sendBeacon)try{l=a.navigator.sendBeacon(c.A.toString(),"")}catch{}!l&&a.Image&&(new Image().src=c.A,l=!0),l||(c.g=Da(c.j,null),c.g.ea(c.A)),c.F=Date.now(),Ir(c)}Pa(i)}function Sr(i){i.g&&(Js(i),i.g.cancel(),i.g=null)}function Aa(i){Sr(i),i.v&&(a.clearTimeout(i.v),i.v=null),Pr(i),i.h.cancel(),i.m&&(typeof i.m=="number"&&a.clearTimeout(i.m),i.m=null)}function Cr(i){if(!sa(i.h)&&!i.m){i.m=!0;var c=i.Ea;J||_(),tt||(J(),tt=!0),E.add(c,i),i.D=0}}function Ad(i,c){return ia(i.h)>=i.h.j-(i.m?1:0)?!1:i.m?(i.i=c.G.concat(i.i),!0):i.I==1||i.I==2||i.D>=(i.Sa?0:i.Ta)?!1:(i.m=Cn(d(i.Ea,i,c),Ca(i,i.D)),i.D++,!0)}n.Ea=function(i){if(this.m)if(this.m=null,this.I==1){if(!i){this.V=Math.floor(Math.random()*1e5),i=this.V++;const R=new le(this,this.j,i);let C=this.o;if(this.U&&(C?(C=yt(C),Qt(C,this.U)):C=this.U),this.u!==null||this.R||(R.J=C,C=null),this.S)t:{for(var c=0,l=0;l<this.i.length;l++){e:{var p=this.i[l];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break e}p=void 0}if(p===void 0)break;if(c+=p,c>4096){c=l;break t}if(c===4096||l===this.i.length-1){c=l+1;break t}}c=1e3}else c=1e3;c=va(this,R,c),l=Xt(this.J),ot(l,"RID",i),ot(l,"CVER",22),this.G&&ot(l,"X-HTTP-Session-Id",this.G),Bn(this,l),C&&(this.R?c="headers="+Vn(ga(C))+"&"+c:this.u&&Ws(l,this.u,C)),Hs(this.h,R),this.Ra&&ot(l,"TYPE","init"),this.S?(ot(l,"$req",c),ot(l,"SID","null"),R.U=!0,js(R,l,null)):js(R,l,c),this.I=2}}else this.I==3&&(i?Ia(this,i):this.i.length==0||sa(this.h)||Ia(this))};function Ia(i,c){var l;c?l=c.l:l=i.V++;const p=Xt(i.J);ot(p,"SID",i.M),ot(p,"RID",l),ot(p,"AID",i.K),Bn(i,p),i.u&&i.o&&Ws(p,i.u,i.o),l=new le(i,i.j,l,i.D+1),i.u===null&&(l.J=i.o),c&&(i.i=c.G.concat(i.i)),c=va(i,l,1e3),l.H=Math.round(i.va*.5)+Math.round(i.va*.5*Math.random()),Hs(i.h,l),js(l,p,c)}function Bn(i,c){i.H&&it(i.H,function(l,p){ot(c,p,l)}),i.l&&it({},function(l,p){ot(c,p,l)})}function va(i,c,l){l=Math.min(i.i.length,l);const p=i.l?d(i.l.Ka,i.l,i):null;t:{var R=i.i;let W=-1;for(;;){const Et=["count="+l];W==-1?l>0?(W=R[0].g,Et.push("ofs="+W)):W=0:Et.push("ofs="+W);let rt=!0;for(let At=0;At<l;At++){var C=R[At].g;const Jt=R[At].map;if(C-=W,C<0)W=Math.max(0,R[At].g-100),rt=!1;else try{C="req"+C+"_"||"";try{var k=Jt instanceof Map?Jt:Object.entries(Jt);for(const[Me,pe]of k){let me=pe;u(pe)&&(me=Ms(pe)),Et.push(C+Me+"="+encodeURIComponent(me))}}catch(Me){throw Et.push(C+"type="+encodeURIComponent("_badmap")),Me}}catch{p&&p(Jt)}}if(rt){k=Et.join("&");break t}}k=void 0}return i=i.i.splice(0,l),c.G=i,k}function Ra(i){if(!i.g&&!i.v){i.Y=1;var c=i.Da;J||_(),tt||(J(),tt=!0),E.add(c,i),i.A=0}}function Xs(i){return i.g||i.v||i.A>=3?!1:(i.Y++,i.v=Cn(d(i.Da,i),Ca(i,i.A)),i.A++,!0)}n.Da=function(){if(this.v=null,ba(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var i=4*this.T;this.j.info("BP detection timer enabled: "+i),this.B=Cn(d(this.Wa,this),i)}},n.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,kt(10),Sr(this),ba(this))};function Js(i){i.B!=null&&(a.clearTimeout(i.B),i.B=null)}function ba(i){i.g=new le(i,i.j,"rpc",i.Y),i.u===null&&(i.g.J=i.o),i.g.P=0;var c=Xt(i.na);ot(c,"RID","rpc"),ot(c,"SID",i.M),ot(c,"AID",i.K),ot(c,"CI",i.F?"0":"1"),!i.F&&i.ia&&ot(c,"TO",i.ia),ot(c,"TYPE","xmlhttp"),Bn(i,c),i.u&&i.o&&Ws(c,i.u,i.o),i.O&&(i.g.H=i.O);var l=i.g;i=i.ba,l.M=1,l.A=vr(Xt(c)),l.u=null,l.R=!0,ta(l,i)}n.Va=function(){this.C!=null&&(this.C=null,Sr(this),Xs(this),kt(19))};function Pr(i){i.C!=null&&(a.clearTimeout(i.C),i.C=null)}function Sa(i,c){var l=null;if(i.g==c){Pr(i),Js(i),i.g=null;var p=2}else if(zs(i.h,c))l=c.G,oa(i.h,c),p=1;else return;if(i.I!=0){if(c.o)if(p==1){l=c.u?c.u.length:0,c=Date.now()-c.F;var R=i.D;p=wr(),Nt(p,new Qo(p,l)),Cr(i)}else Ra(i);else if(R=c.m,R==3||R==0&&c.X>0||!(p==1&&Ad(i,c)||p==2&&Xs(i)))switch(l&&l.length>0&&(c=i.h,c.i=c.i.concat(l)),R){case 1:xe(i,5);break;case 4:xe(i,10);break;case 3:xe(i,6);break;default:xe(i,2)}}}function Ca(i,c){let l=i.Qa+Math.floor(Math.random()*i.Za);return i.isActive()||(l*=2),l*c}function xe(i,c){if(i.j.info("Error code "+c),c==2){var l=d(i.bb,i),p=i.Ua;const R=!p;p=new he(p||"//www.google.com/images/cleardot.gif"),a.location&&a.location.protocol=="http"||Nn(p,"https"),vr(p),R?gd(p.toString(),l):_d(p.toString(),l)}else kt(2);i.I=0,i.l&&i.l.pa(c),Pa(i),Aa(i)}n.bb=function(i){i?(this.j.info("Successfully pinged google.com"),kt(2)):(this.j.info("Failed to ping google.com"),kt(1))};function Pa(i){if(i.I=0,i.ja=[],i.l){const c=aa(i.h);(c.length!=0||i.i.length!=0)&&(v(i.ja,c),v(i.ja,i.i),i.h.i.length=0,P(i.i),i.i.length=0),i.l.oa()}}function Va(i,c,l){var p=l instanceof he?Xt(l):new he(l);if(p.g!="")c&&(p.g=c+"."+p.g),kn(p,p.u);else{var R=a.location;p=R.protocol,c=c?c+"."+R.hostname:R.hostname,R=+R.port;const C=new he(null);p&&Nn(C,p),c&&(C.g=c),R&&kn(C,R),l&&(C.h=l),p=C}return l=i.G,c=i.wa,l&&c&&ot(p,l,c),ot(p,"VER",i.ka),Bn(i,p),p}function Da(i,c,l){if(c&&!i.L)throw Error("Can't create secondary domain capable XhrIo object.");return c=i.Aa&&!i.ma?new ut(new Ks({ab:l})):new ut(i.ma),c.Fa(i.L),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function Na(){}n=Na.prototype,n.ra=function(){},n.qa=function(){},n.pa=function(){},n.oa=function(){},n.isActive=function(){return!0},n.Ka=function(){};function Vr(){}Vr.prototype.g=function(i,c){return new jt(i,c)};function jt(i,c){St.call(this),this.g=new wa(c),this.l=i,this.h=c&&c.messageUrlParams||null,i=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(i?i["X-Client-Protocol"]="webchannel":i={"X-Client-Protocol":"webchannel"}),this.g.o=i,i=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(i?i["X-WebChannel-Content-Type"]=c.messageContentType:i={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.sa&&(i?i["X-WebChannel-Client-Profile"]=c.sa:i={"X-WebChannel-Client-Profile":c.sa}),this.g.U=i,(i=c&&c.Qb)&&!m(i)&&(this.g.u=i),this.A=c&&c.supportsCrossDomainXhr||!1,this.v=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!m(c)&&(this.g.G=c,i=this.h,i!==null&&c in i&&(i=this.h,c in i&&delete i[c])),this.j=new en(this)}g(jt,St),jt.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},jt.prototype.close=function(){Qs(this.g)},jt.prototype.o=function(i){var c=this.g;if(typeof i=="string"){var l={};l.__data__=i,i=l}else this.v&&(l={},l.__data__=Ms(i),i=l);c.i.push(new cd(c.Ya++,i)),c.I==3&&Cr(c)},jt.prototype.N=function(){this.g.l=null,delete this.j,Qs(this.g),delete this.g,jt.Z.N.call(this)};function ka(i){Ls.call(this),i.__headers__&&(this.headers=i.__headers__,this.statusCode=i.__status__,delete i.__headers__,delete i.__status__);var c=i.__sm__;if(c){t:{for(const l in c){i=l;break t}i=void 0}(this.i=i)&&(i=this.i,c=c!==null&&i in c?c[i]:void 0),this.data=c}else this.data=i}g(ka,Ls);function Oa(){Fs.call(this),this.status=1}g(Oa,Fs);function en(i){this.g=i}g(en,Na),en.prototype.ra=function(){Nt(this.g,"a")},en.prototype.qa=function(i){Nt(this.g,new ka(i))},en.prototype.pa=function(i){Nt(this.g,new Oa)},en.prototype.oa=function(){Nt(this.g,"b")},Vr.prototype.createWebChannel=Vr.prototype.g,jt.prototype.send=jt.prototype.o,jt.prototype.open=jt.prototype.m,jt.prototype.close=jt.prototype.close,cl=function(){return new Vr},al=function(){return wr()},ol=Ne,Ii={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Ar.NO_ERROR=0,Ar.TIMEOUT=8,Ar.HTTP_ERROR=6,$r=Ar,Xo.COMPLETE="complete",il=Xo,Ho.EventType=bn,bn.OPEN="a",bn.CLOSE="b",bn.ERROR="c",bn.MESSAGE="d",St.prototype.listen=St.prototype.J,$n=Ho,ut.prototype.listenOnce=ut.prototype.K,ut.prototype.getLastError=ut.prototype.Ha,ut.prototype.getLastErrorCode=ut.prototype.ya,ut.prototype.getStatus=ut.prototype.ca,ut.prototype.getResponseJson=ut.prototype.La,ut.prototype.getResponseText=ut.prototype.la,ut.prototype.send=ut.prototype.ea,ut.prototype.setWithCredentials=ut.prototype.Fa,sl=ut}).apply(typeof kr<"u"?kr:typeof self<"u"?self:typeof window<"u"?window:{});const uc="@firebase/firestore",lc="4.9.2";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc="__name__";class Zt{constructor(t,e,r){e===void 0?e=0:e>t.length&&q(637,{offset:e,range:t.length}),r===void 0?r=t.length-e:r>t.length-e&&q(1746,{length:r,range:t.length-e}),this.segments=t,this.offset=e,this.len=r}get length(){return this.len}isEqual(t){return Zt.comparator(this,t)===0}child(t){const e=this.segments.slice(this.offset,this.limit());return t instanceof Zt?t.forEach((r=>{e.push(r)})):e.push(t),this.construct(e)}limit(){return this.offset+this.length}popFirst(t){return t=t===void 0?1:t,this.construct(this.segments,this.offset+t,this.length-t)}popLast(){return this.construct(this.segments,this.offset,this.length-1)}firstSegment(){return this.segments[this.offset]}lastSegment(){return this.get(this.length-1)}get(t){return this.segments[this.offset+t]}isEmpty(){return this.length===0}isPrefixOf(t){if(t.length<this.length)return!1;for(let e=0;e<this.length;e++)if(this.get(e)!==t.get(e))return!1;return!0}isImmediateParentOf(t){if(this.length+1!==t.length)return!1;for(let e=0;e<this.length;e++)if(this.get(e)!==t.get(e))return!1;return!0}forEach(t){for(let e=this.offset,r=this.limit();e<r;e++)t(this.segments[e])}toArray(){return this.segments.slice(this.offset,this.limit())}static comparator(t,e){const r=Math.min(t.length,e.length);for(let s=0;s<r;s++){const o=Zt.compareSegments(t.get(s),e.get(s));if(o!==0)return o}return Q(t.length,e.length)}static compareSegments(t,e){const r=Zt.isNumericId(t),s=Zt.isNumericId(e);return r&&!s?-1:!r&&s?1:r&&s?Zt.extractNumericId(t).compare(Zt.extractNumericId(e)):vi(t,e)}static isNumericId(t){return t.startsWith("__id")&&t.endsWith("__")}static extractNumericId(t){return we.fromString(t.substring(4,t.length-2))}}class st extends Zt{construct(t,e,r){return new st(t,e,r)}canonicalString(){return this.toArray().join("/")}toString(){return this.canonicalString()}toUriEncodedString(){return this.toArray().map(encodeURIComponent).join("/")}static fromString(...t){const e=[];for(const r of t){if(r.indexOf("//")>=0)throw new O(D.INVALID_ARGUMENT,`Invalid segment (${r}). Paths must not contain // in them.`);e.push(...r.split("/").filter((s=>s.length>0)))}return new st(e)}static emptyPath(){return new st([])}}const Fm=/^[_a-zA-Z][_a-zA-Z0-9]*$/;class Rt extends Zt{construct(t,e,r){return new Rt(t,e,r)}static isValidIdentifier(t){return Fm.test(t)}canonicalString(){return this.toArray().map((t=>(t=t.replace(/\\/g,"\\\\").replace(/`/g,"\\`"),Rt.isValidIdentifier(t)||(t="`"+t+"`"),t))).join(".")}toString(){return this.canonicalString()}isKeyField(){return this.length===1&&this.get(0)===dc}static keyField(){return new Rt([dc])}static fromServerFormat(t){const e=[];let r="",s=0;const o=()=>{if(r.length===0)throw new O(D.INVALID_ARGUMENT,`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`);e.push(r),r=""};let a=!1;for(;s<t.length;){const u=t[s];if(u==="\\"){if(s+1===t.length)throw new O(D.INVALID_ARGUMENT,"Path has trailing escape character: "+t);const h=t[s+1];if(h!=="\\"&&h!=="."&&h!=="`")throw new O(D.INVALID_ARGUMENT,"Path has invalid escape sequence: "+t);r+=h,s+=2}else u==="`"?(a=!a,s++):u!=="."||a?(r+=u,s++):(o(),s++)}if(o(),a)throw new O(D.INVALID_ARGUMENT,"Unterminated ` in path: "+t);return new Rt(e)}static emptyPath(){return new Rt([])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const er=-1;function Bm(n,t){const e=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,s=z.fromTimestamp(r===1e9?new at(e+1,0):new at(e,r));return new ve(s,U.empty(),t)}function jm(n){return new ve(n.readTime,n.key,er)}class ve{constructor(t,e,r){this.readTime=t,this.documentKey=e,this.largestBatchId=r}static min(){return new ve(z.min(),U.empty(),er)}static max(){return new ve(z.max(),U.empty(),er)}}function qm(n,t){let e=n.readTime.compareTo(t.readTime);return e!==0?e:(e=U.comparator(n.documentKey,t.documentKey),e!==0?e:Q(n.largestBatchId,t.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yc(n){let t=0;for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t++;return t}function Ve(n,t){for(const e in n)Object.prototype.hasOwnProperty.call(n,e)&&t(e,n[e])}function pl(n){for(const t in n)if(Object.prototype.hasOwnProperty.call(n,t))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tt{constructor(t){this.comparator=t,this.data=new ct(this.comparator)}has(t){return this.data.get(t)!==null}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal(((e,r)=>(t(e),!1)))}forEachInRange(t,e){const r=this.data.getIteratorFrom(t[0]);for(;r.hasNext();){const s=r.getNext();if(this.comparator(s.key,t[1])>=0)return;e(s.key)}}forEachWhile(t,e){let r;for(r=e!==void 0?this.data.getIteratorFrom(e):this.data.getIterator();r.hasNext();)if(!t(r.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new Ec(this.data.getIterator())}getIteratorFrom(t){return new Ec(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach((r=>{e=e.add(r)})),e}isEqual(t){if(!(t instanceof Tt)||this.size!==t.size)return!1;const e=this.data.getIterator(),r=t.data.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(this.comparator(s,o)!==0)return!1}return!0}toArray(){const t=[];return this.forEach((e=>{t.push(e)})),t}toString(){const t=[];return this.forEach((e=>t.push(e))),"SortedSet("+t.toString()+")"}copy(t){const e=new Tt(this.comparator);return e.data=t,e}}class Ec{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qt{constructor(t){this.fields=t,t.sort(Rt.comparator)}static empty(){return new qt([])}unionWith(t){let e=new Tt(Rt.comparator);for(const r of this.fields)e=e.add(r);for(const r of t)e=e.add(r);return new qt(e.toArray())}covers(t){for(const e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return dn(this.fields,t.fields,((e,r)=>e.isEqual(r)))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{constructor(t){this.binaryString=t}static fromBase64String(t){const e=(function(s){try{return atob(s)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new ml("Invalid base64 string: "+o):o}})(t);return new bt(e)}static fromUint8Array(t){const e=(function(s){let o="";for(let a=0;a<s.length;++a)o+=String.fromCharCode(s[a]);return o})(t);return new bt(e)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(e){return btoa(e)})(this.binaryString)}toUint8Array(){return(function(e){const r=new Uint8Array(e.length);for(let s=0;s<e.length;s++)r[s]=e.charCodeAt(s);return r})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return Q(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}bt.EMPTY_BYTE_STRING=new bt("");const Qm=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Re(n){if(et(!!n,39018),typeof n=="string"){let t=0;const e=Qm.exec(n);if(et(!!e,46558,{timestamp:n}),e[1]){let s=e[1];s=(s+"000000000").substr(0,9),t=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:t}}return{seconds:dt(n.seconds),nanos:dt(n.nanos)}}function dt(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function be(n){return typeof n=="string"?bt.fromBase64String(n):bt.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gl="server_timestamp",_l="__type__",yl="__previous_value__",El="__local_write_time__";function Ji(n){return(n?.mapValue?.fields||{})[_l]?.stringValue===gl}function _s(n){const t=n.mapValue.fields[yl];return Ji(t)?_s(t):t}function nr(n){const t=Re(n.mapValue.fields[El].timestampValue);return new at(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tl="__type__",Jm="__max__",xr={mapValue:{}},wl="__vector__",es="value";function Se(n){return"nullValue"in n?0:"booleanValue"in n?1:"integerValue"in n||"doubleValue"in n?2:"timestampValue"in n?3:"stringValue"in n?5:"bytesValue"in n?6:"referenceValue"in n?7:"geoPointValue"in n?8:"arrayValue"in n?9:"mapValue"in n?Ji(n)?4:Zm(n)?9007199254740991:Ym(n)?10:11:q(28295,{value:n})}function ie(n,t){if(n===t)return!0;const e=Se(n);if(e!==Se(t))return!1;switch(e){case 0:case 9007199254740991:return!0;case 1:return n.booleanValue===t.booleanValue;case 4:return nr(n).isEqual(nr(t));case 3:return(function(s,o){if(typeof s.timestampValue=="string"&&typeof o.timestampValue=="string"&&s.timestampValue.length===o.timestampValue.length)return s.timestampValue===o.timestampValue;const a=Re(s.timestampValue),u=Re(o.timestampValue);return a.seconds===u.seconds&&a.nanos===u.nanos})(n,t);case 5:return n.stringValue===t.stringValue;case 6:return(function(s,o){return be(s.bytesValue).isEqual(be(o.bytesValue))})(n,t);case 7:return n.referenceValue===t.referenceValue;case 8:return(function(s,o){return dt(s.geoPointValue.latitude)===dt(o.geoPointValue.latitude)&&dt(s.geoPointValue.longitude)===dt(o.geoPointValue.longitude)})(n,t);case 2:return(function(s,o){if("integerValue"in s&&"integerValue"in o)return dt(s.integerValue)===dt(o.integerValue);if("doubleValue"in s&&"doubleValue"in o){const a=dt(s.doubleValue),u=dt(o.doubleValue);return a===u?Zr(a)===Zr(u):isNaN(a)&&isNaN(u)}return!1})(n,t);case 9:return dn(n.arrayValue.values||[],t.arrayValue.values||[],ie);case 10:case 11:return(function(s,o){const a=s.mapValue.fields||{},u=o.mapValue.fields||{};if(yc(a)!==yc(u))return!1;for(const h in a)if(a.hasOwnProperty(h)&&(u[h]===void 0||!ie(a[h],u[h])))return!1;return!0})(n,t);default:return q(52216,{left:n})}}function sr(n,t){return(n.values||[]).find((e=>ie(e,t)))!==void 0}function fn(n,t){if(n===t)return 0;const e=Se(n),r=Se(t);if(e!==r)return Q(e,r);switch(e){case 0:case 9007199254740991:return 0;case 1:return Q(n.booleanValue,t.booleanValue);case 2:return(function(o,a){const u=dt(o.integerValue||o.doubleValue),h=dt(a.integerValue||a.doubleValue);return u<h?-1:u>h?1:u===h?0:isNaN(u)?isNaN(h)?0:-1:1})(n,t);case 3:return Tc(n.timestampValue,t.timestampValue);case 4:return Tc(nr(n),nr(t));case 5:return vi(n.stringValue,t.stringValue);case 6:return(function(o,a){const u=be(o),h=be(a);return u.compareTo(h)})(n.bytesValue,t.bytesValue);case 7:return(function(o,a){const u=o.split("/"),h=a.split("/");for(let d=0;d<u.length&&d<h.length;d++){const f=Q(u[d],h[d]);if(f!==0)return f}return Q(u.length,h.length)})(n.referenceValue,t.referenceValue);case 8:return(function(o,a){const u=Q(dt(o.latitude),dt(a.latitude));return u!==0?u:Q(dt(o.longitude),dt(a.longitude))})(n.geoPointValue,t.geoPointValue);case 9:return wc(n.arrayValue,t.arrayValue);case 10:return(function(o,a){const u=o.fields||{},h=a.fields||{},d=u[es]?.arrayValue,f=h[es]?.arrayValue,g=Q(d?.values?.length||0,f?.values?.length||0);return g!==0?g:wc(d,f)})(n.mapValue,t.mapValue);case 11:return(function(o,a){if(o===xr.mapValue&&a===xr.mapValue)return 0;if(o===xr.mapValue)return 1;if(a===xr.mapValue)return-1;const u=o.fields||{},h=Object.keys(u),d=a.fields||{},f=Object.keys(d);h.sort(),f.sort();for(let g=0;g<h.length&&g<f.length;++g){const w=vi(h[g],f[g]);if(w!==0)return w;const P=fn(u[h[g]],d[f[g]]);if(P!==0)return P}return Q(h.length,f.length)})(n.mapValue,t.mapValue);default:throw q(23264,{he:e})}}function Tc(n,t){if(typeof n=="string"&&typeof t=="string"&&n.length===t.length)return Q(n,t);const e=Re(n),r=Re(t),s=Q(e.seconds,r.seconds);return s!==0?s:Q(e.nanos,r.nanos)}function wc(n,t){const e=n.values||[],r=t.values||[];for(let s=0;s<e.length&&s<r.length;++s){const o=fn(e[s],r[s]);if(o)return o}return Q(e.length,r.length)}function pn(n){return Ri(n)}function Ri(n){return"nullValue"in n?"null":"booleanValue"in n?""+n.booleanValue:"integerValue"in n?""+n.integerValue:"doubleValue"in n?""+n.doubleValue:"timestampValue"in n?(function(e){const r=Re(e);return`time(${r.seconds},${r.nanos})`})(n.timestampValue):"stringValue"in n?n.stringValue:"bytesValue"in n?(function(e){return be(e).toBase64()})(n.bytesValue):"referenceValue"in n?(function(e){return U.fromName(e).toString()})(n.referenceValue):"geoPointValue"in n?(function(e){return`geo(${e.latitude},${e.longitude})`})(n.geoPointValue):"arrayValue"in n?(function(e){let r="[",s=!0;for(const o of e.values||[])s?s=!1:r+=",",r+=Ri(o);return r+"]"})(n.arrayValue):"mapValue"in n?(function(e){const r=Object.keys(e.fields||{}).sort();let s="{",o=!0;for(const a of r)o?o=!1:s+=",",s+=`${a}:${Ri(e.fields[a])}`;return s+"}"})(n.mapValue):q(61005,{value:n})}function zr(n){switch(Se(n)){case 0:case 1:return 4;case 2:return 8;case 3:case 8:return 16;case 4:const t=_s(n);return t?16+zr(t):16;case 5:return 2*n.stringValue.length;case 6:return be(n.bytesValue).approximateByteSize();case 7:return n.referenceValue.length;case 9:return(function(r){return(r.values||[]).reduce(((s,o)=>s+zr(o)),0)})(n.arrayValue);case 10:case 11:return(function(r){let s=0;return Ve(r.fields,((o,a)=>{s+=o.length+zr(a)})),s})(n.mapValue);default:throw q(13486,{value:n})}}function Ac(n,t){return{referenceValue:`projects/${n.projectId}/databases/${n.database}/documents/${t.path.canonicalString()}`}}function bi(n){return!!n&&"integerValue"in n}function Yi(n){return!!n&&"arrayValue"in n}function Ic(n){return!!n&&"nullValue"in n}function vc(n){return!!n&&"doubleValue"in n&&isNaN(Number(n.doubleValue))}function Hr(n){return!!n&&"mapValue"in n}function Ym(n){return(n?.mapValue?.fields||{})[Tl]?.stringValue===wl}function Wn(n){if(n.geoPointValue)return{geoPointValue:{...n.geoPointValue}};if(n.timestampValue&&typeof n.timestampValue=="object")return{timestampValue:{...n.timestampValue}};if(n.mapValue){const t={mapValue:{fields:{}}};return Ve(n.mapValue.fields,((e,r)=>t.mapValue.fields[e]=Wn(r))),t}if(n.arrayValue){const t={arrayValue:{values:[]}};for(let e=0;e<(n.arrayValue.values||[]).length;++e)t.arrayValue.values[e]=Wn(n.arrayValue.values[e]);return t}return{...n}}function Zm(n){return(((n.mapValue||{}).fields||{}).__type__||{}).stringValue===Jm}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Il{}class mt extends Il{constructor(t,e,r){super(),this.field=t,this.op=e,this.value=r}static create(t,e,r){return t.isKeyField()?e==="in"||e==="not-in"?this.createKeyFieldInFilter(t,e,r):new ng(t,e,r):e==="array-contains"?new ig(t,r):e==="in"?new og(t,r):e==="not-in"?new ag(t,r):e==="array-contains-any"?new cg(t,r):new mt(t,e,r)}static createKeyFieldInFilter(t,e,r){return e==="in"?new rg(t,r):new sg(t,r)}matches(t){const e=t.data.field(this.field);return this.op==="!="?e!==null&&e.nullValue===void 0&&this.matchesComparison(fn(e,this.value)):e!==null&&Se(this.value)===Se(e)&&this.matchesComparison(fn(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return q(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Kt extends Il{constructor(t,e){super(),this.filters=t,this.op=e,this.Pe=null}static create(t,e){return new Kt(t,e)}matches(t){return vl(this)?this.filters.find((e=>!e.matches(t)))===void 0:this.filters.find((e=>e.matches(t)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((t,e)=>t.concat(e.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function vl(n){return n.op==="and"}function Rl(n){return eg(n)&&vl(n)}function eg(n){for(const t of n.filters)if(t instanceof Kt)return!1;return!0}function Si(n){if(n instanceof mt)return n.field.canonicalString()+n.op.toString()+pn(n.value);if(Rl(n))return n.filters.map((t=>Si(t))).join(",");{const t=n.filters.map((e=>Si(e))).join(",");return`${n.op}(${t})`}}function bl(n,t){return n instanceof mt?(function(r,s){return s instanceof mt&&r.op===s.op&&r.field.isEqual(s.field)&&ie(r.value,s.value)})(n,t):n instanceof Kt?(function(r,s){return s instanceof Kt&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce(((o,a,u)=>o&&bl(a,s.filters[u])),!0):!1})(n,t):void q(19439)}function Sl(n){return n instanceof mt?(function(e){return`${e.field.canonicalString()} ${e.op} ${pn(e.value)}`})(n):n instanceof Kt?(function(e){return e.op.toString()+" {"+e.getFilters().map(Sl).join(" ,")+"}"})(n):"Filter"}class ng extends mt{constructor(t,e,r){super(t,e,r),this.key=U.fromName(r.referenceValue)}matches(t){const e=U.comparator(t.key,this.key);return this.matchesComparison(e)}}class rg extends mt{constructor(t,e){super(t,"in",e),this.keys=Cl("in",e)}matches(t){return this.keys.some((e=>e.isEqual(t.key)))}}class sg extends mt{constructor(t,e){super(t,"not-in",e),this.keys=Cl("not-in",e)}matches(t){return!this.keys.some((e=>e.isEqual(t.key)))}}function Cl(n,t){return(t.arrayValue?.values||[]).map((e=>U.fromName(e.referenceValue)))}class ig extends mt{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return Yi(e)&&sr(e.arrayValue,this.value)}}class og extends mt{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return e!==null&&sr(this.value.arrayValue,e)}}class ag extends mt{constructor(t,e){super(t,"not-in",e)}matches(t){if(sr(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return e!==null&&e.nullValue===void 0&&!sr(this.value.arrayValue,e)}}class cg extends mt{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!Yi(e)||!e.arrayValue.values)&&e.arrayValue.values.some((r=>sr(this.value.arrayValue,r)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kg=new we([4294967295,4294967295],0);function kc(n){const t=Ng().encode(n),e=new rl;return e.update(t),new Uint8Array(e.digest())}function Oc(n){const t=new DataView(n.buffer),e=t.getUint32(0,!0),r=t.getUint32(4,!0),s=t.getUint32(8,!0),o=t.getUint32(12,!0);return[new we([e,r],0),new we([s,o],0)]}class io{constructor(t,e,r){if(this.bitmap=t,this.padding=e,this.hashCount=r,e<0||e>=8)throw new Hn(`Invalid padding: ${e}`);if(r<0)throw new Hn(`Invalid hash count: ${r}`);if(t.length>0&&this.hashCount===0)throw new Hn(`Invalid hash count: ${r}`);if(t.length===0&&e!==0)throw new Hn(`Invalid padding when bitmap length is 0: ${e}`);this.ge=8*t.length-e,this.pe=we.fromNumber(this.ge)}ye(t,e,r){let s=t.add(e.multiply(we.fromNumber(r)));return s.compare(kg)===1&&(s=new we([s.getBits(0),s.getBits(1)],0)),s.modulo(this.pe).toNumber()}we(t){return!!(this.bitmap[Math.floor(t/8)]&1<<t%8)}mightContain(t){if(this.ge===0)return!1;const e=kc(t),[r,s]=Oc(e);for(let o=0;o<this.hashCount;o++){const a=this.ye(r,s,o);if(!this.we(a))return!1}return!0}static create(t,e,r){const s=t%8==0?0:8-t%8,o=new Uint8Array(Math.ceil(t/8)),a=new io(o,s,e);return r.forEach((u=>a.insert(u))),a}insert(t){if(this.ge===0)return;const e=kc(t),[r,s]=Oc(e);for(let o=0;o<this.hashCount;o++){const a=this.ye(r,s,o);this.Se(a)}}Se(t){const e=Math.floor(t/8),r=t%8;this.bitmap[e]|=1<<r}}class Hn extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class As{constructor(t,e,r,s,o){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(t,e,r){const s=new Map;return s.set(t,gr.createSynthesizedTargetChangeForCurrentChange(t,e,r)),new As(z.min(),s,new ct(Q),ue(),X())}}class gr{constructor(t,e,r,s,o){this.resumeToken=t,this.current=e,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(t,e,r){return new gr(r,e,X(),X(),X())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{constructor(){this.Qr=new Tt(It.$r),this.Ur=new Tt(It.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(t,e){const r=new It(t,e);this.Qr=this.Qr.add(r),this.Ur=this.Ur.add(r)}Wr(t,e){t.forEach((r=>this.addReference(r,e)))}removeReference(t,e){this.Gr(new It(t,e))}zr(t,e){t.forEach((r=>this.removeReference(r,e)))}jr(t){const e=new U(new st([])),r=new It(e,t),s=new It(e,t+1),o=[];return this.Ur.forEachInRange([r,s],(a=>{this.Gr(a),o.push(a.key)})),o}Jr(){this.Qr.forEach((t=>this.Gr(t)))}Gr(t){this.Qr=this.Qr.delete(t),this.Ur=this.Ur.delete(t)}Hr(t){const e=new U(new st([])),r=new It(e,t),s=new It(e,t+1);let o=X();return this.Ur.forEachInRange([r,s],(a=>{o=o.add(a.key)})),o}containsKey(t){const e=new It(t,0),r=this.Qr.firstAfterOrEqual(e);return r!==null&&t.isEqual(r.key)}}class It{constructor(t,e){this.key=t,this.Yr=e}static $r(t,e){return U.comparator(t.key,e.key)||Q(t.Yr,e.Yr)}static Kr(t,e){return Q(t.Yr,e.Yr)||U.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class f_{constructor(t,e){this.indexManager=t,this.referenceDelegate=e,this.mutationQueue=[],this.tr=1,this.Zr=new Tt(It.$r)}checkEmpty(t){return N.resolve(this.mutationQueue.length===0)}addMutationBatch(t,e,r,s){const o=this.tr;this.tr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new Cg(o,e,r,s);this.mutationQueue.push(a);for(const u of s)this.Zr=this.Zr.add(new It(u.key,o)),this.indexManager.addToCollectionParentIndex(t,u.key.path.popLast());return N.resolve(a)}lookupMutationBatch(t,e){return N.resolve(this.Xr(e))}getNextMutationBatchAfterBatchId(t,e){const r=e+1,s=this.ei(r),o=s<0?0:s;return N.resolve(this.mutationQueue.length>o?this.mutationQueue[o]:null)}getHighestUnacknowledgedBatchId(){return N.resolve(this.mutationQueue.length===0?Xi:this.tr-1)}getAllMutationBatches(t){return N.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){const r=new It(e,0),s=new It(e,Number.POSITIVE_INFINITY),o=[];return this.Zr.forEachInRange([r,s],(a=>{const u=this.Xr(a.Yr);o.push(u)})),N.resolve(o)}getAllMutationBatchesAffectingDocumentKeys(t,e){let r=new Tt(Q);return e.forEach((s=>{const o=new It(s,0),a=new It(s,Number.POSITIVE_INFINITY);this.Zr.forEachInRange([o,a],(u=>{r=r.add(u.Yr)}))})),N.resolve(this.ti(r))}getAllMutationBatchesAffectingQuery(t,e){const r=e.path,s=r.length+1;let o=r;U.isDocumentKey(o)||(o=o.child(""));const a=new It(new U(o),0);let u=new Tt(Q);return this.Zr.forEachWhile((h=>{const d=h.key.path;return!!r.isPrefixOf(d)&&(d.length===s&&(u=u.add(h.Yr)),!0)}),a),N.resolve(this.ti(u))}ti(t){const e=[];return t.forEach((r=>{const s=this.Xr(r);s!==null&&e.push(s)})),e}removeMutationBatch(t,e){et(this.ni(e.batchId,"removed")===0,55003),this.mutationQueue.shift();let r=this.Zr;return N.forEach(e.mutations,(s=>{const o=new It(s.key,e.batchId);return r=r.delete(o),this.referenceDelegate.markPotentiallyOrphaned(t,s.key)})).next((()=>{this.Zr=r}))}ir(t){}containsKey(t,e){const r=new It(e,0),s=this.Zr.firstAfterOrEqual(r);return N.resolve(e.isEqual(s&&s.key))}performConsistencyCheck(t){return this.mutationQueue.length,N.resolve()}ni(t,e){return this.ei(t)}ei(t){return this.mutationQueue.length===0?0:t-this.mutationQueue[0].batchId}Xr(t){const e=this.ei(t);return e<0||e>=this.mutationQueue.length?null:this.mutationQueue[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class p_{constructor(t){this.ri=t,this.docs=(function(){return new ct(U.comparator)})(),this.size=0}setIndexManager(t){this.indexManager=t}addEntry(t,e){const r=e.key,s=this.docs.get(r),o=s?s.size:0,a=this.ri(e);return this.docs=this.docs.insert(r,{document:e.mutableCopy(),size:a}),this.size+=a-o,this.indexManager.addToCollectionParentIndex(t,r.path.popLast())}removeEntry(t){const e=this.docs.get(t);e&&(this.docs=this.docs.remove(t),this.size-=e.size)}getEntry(t,e){const r=this.docs.get(e);return N.resolve(r?r.document.mutableCopy():Vt.newInvalidDocument(e))}getEntries(t,e){let r=ue();return e.forEach((s=>{const o=this.docs.get(s);r=r.insert(s,o?o.document.mutableCopy():Vt.newInvalidDocument(s))})),N.resolve(r)}getDocumentsMatchingQuery(t,e,r,s){let o=ue();const a=e.path,u=new U(a.child("__id-9223372036854775808__")),h=this.docs.getIteratorFrom(u);for(;h.hasNext();){const{key:d,value:{document:f}}=h.getNext();if(!a.isPrefixOf(d.path))break;d.path.length>a.length+1||qm(jm(f),r)<=0||(s.has(f.key)||Es(e,f))&&(o=o.insert(f.key,f.mutableCopy()))}return N.resolve(o)}getAllFromCollectionGroup(t,e,r,s){q(9500)}ii(t,e){return N.forEach(this.docs,(r=>e(r)))}newChangeBuffer(t){return new m_(this)}getSize(t){return N.resolve(this.size)}}class m_ extends a_{constructor(t){super(),this.Nr=t}applyChanges(t){const e=[];return this.changes.forEach(((r,s)=>{s.isValidDocument()?e.push(this.Nr.addEntry(t,s)):this.Nr.removeEntry(r)})),N.waitFor(e)}getFromCache(t,e){return this.Nr.getEntry(t,e)}getAllFromCache(t,e){return this.Nr.getEntries(t,e)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;this.aa?(ce(e),this.aa=!1):M("OnlineStateTracker",e)}Pa(){this._a!==null&&(this._a.cancel(),this._a=null)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Iy{constructor(t){this.observer=t,this.muted=!1}next(t){this.muted||this.observer.next&&this.Ou(this.observer.next,t)}error(t){this.muted||(this.observer.error?this.Ou(this.observer.error,t):ce("Uncaught Error in snapshot listener:",t.toString()))}Nu(){this.muted=!0}Ou(t,e){setTimeout((()=>{this.muted||t(e)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new Je(this.firestore,t,this._query)}}class _t{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ie(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new _t(this.firestore,t,this._key)}toJSON(){return{type:_t._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(t,e,r){if(pr(e,_t._jsonSchema))return new _t(t,r||null,new U(st.fromString(e.referencePath)))}}_t._jsonSchemaVersion="firestore/documentReference/1.0",_t._jsonSchema={type:gt("string",_t._jsonSchemaVersion),referencePath:gt("string")};class Ie extends Je{constructor(t,e,r){super(t,e,eo(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new _t(this.firestore,null,new U(t))}withConverter(t){return new Ie(this.firestore,t,this._path)}}function Cy(n,t,...e){if(n=Bt(n),hl("collection","path",t),n instanceof bs){const r=st.fromString(t,...e);return pc(r),new Ie(n,null,r)}{if(!(n instanceof _t||n instanceof Ie))throw new O(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(st.fromString(t,...e));return pc(r),new Ie(n.firestore,null,r)}}function Bi(n,t,...e){if(n=Bt(n),arguments.length===1&&(t=Qi.newId()),hl("doc","path",t),n instanceof bs){const r=st.fromString(t,...e);return fc(r),new _t(n,null,new U(r))}{if(!(n instanceof _t||n instanceof Ie))throw new O(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(st.fromString(t,...e));return fc(r),new _t(n.firestore,n instanceof Ie?n.converter:null,new U(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ht extends We{constructor(t,e,r=0){super(hi(t),`Firebase Storage: ${e} (${hi(t)})`),this.status_=r,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,ht.prototype)}get status(){return this.status_}set status(t){this.status_=t}_codeEquals(t){return hi(t)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(t){this.customData.serverResponse=t,this.customData.serverResponse?this.message=`${this._baseMessage}
${this.customData.serverResponse}`:this.message=this._baseMessage}}var lt;(function(n){n.UNKNOWN="unknown",n.OBJECT_NOT_FOUND="object-not-found",n.BUCKET_NOT_FOUND="bucket-not-found",n.PROJECT_NOT_FOUND="project-not-found",n.QUOTA_EXCEEDED="quota-exceeded",n.UNAUTHENTICATED="unauthenticated",n.UNAUTHORIZED="unauthorized",n.UNAUTHORIZED_APP="unauthorized-app",n.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",n.INVALID_CHECKSUM="invalid-checksum",n.CANCELED="canceled",n.INVALID_EVENT_NAME="invalid-event-name",n.INVALID_URL="invalid-url",n.INVALID_DEFAULT_BUCKET="invalid-default-bucket",n.NO_DEFAULT_BUCKET="no-default-bucket",n.CANNOT_SLICE_BLOB="cannot-slice-blob",n.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",n.NO_DOWNLOAD_URL="no-download-url",n.INVALID_ARGUMENT="invalid-argument",n.INVALID_ARGUMENT_COUNT="invalid-argument-count",n.APP_DELETED="app-deleted",n.INVALID_ROOT_OPERATION="invalid-root-operation",n.INVALID_FORMAT="invalid-format",n.INTERNAL_ERROR="internal-error",n.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(lt||(lt={}));function hi(n){return"storage/"+n}function No(){const n="An unknown error occurred, please check the error payload for server response.";return new ht(lt.UNKNOWN,n)}function Zy(n){return new ht(lt.OBJECT_NOT_FOUND,"Object '"+n+"' does not exist.")}function tE(n){return new ht(lt.QUOTA_EXCEEDED,"Quota for bucket '"+n+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function eE(){const n="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new ht(lt.UNAUTHENTICATED,n)}function nE(){return new ht(lt.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function rE(n){return new ht(lt.UNAUTHORIZED,"User does not have permission to access '"+n+"'.")}function sE(){return new ht(lt.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function iE(){return new ht(lt.CANCELED,"User canceled the upload/download.")}function oE(n){return new ht(lt.INVALID_URL,"Invalid URL '"+n+"'.")}function aE(n){return new ht(lt.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+n+"'.")}function cE(){return new ht(lt.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+Nh+"' property when initializing the app?")}function uE(){return new ht(lt.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function lE(){return new ht(lt.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function hE(n){return new ht(lt.UNSUPPORTED_ENVIRONMENT,`${n} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function qi(n){return new ht(lt.INVALID_ARGUMENT,n)}function kh(){return new ht(lt.APP_DELETED,"The Firebase app was deleted.")}function dE(n){return new ht(lt.INVALID_ROOT_OPERATION,"The operation '"+n+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Yn(n,t){return new ht(lt.INVALID_FORMAT,"String does not match format '"+n+"': "+t)}function qn(n){throw new ht(lt.INTERNAL_ERROR,"Internal error: "+n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ge{constructor(t,e){let r=0,s="";lu(t)?(this.data_=t,r=t.size,s=t.type):t instanceof ArrayBuffer?(e?this.data_=new Uint8Array(t):(this.data_=new Uint8Array(t.byteLength),this.data_.set(new Uint8Array(t))),r=this.data_.length):t instanceof Uint8Array&&(e?this.data_=t:(this.data_=new Uint8Array(t.length),this.data_.set(t)),r=t.length),this.size_=r,this.type_=s}size(){return this.size_}type(){return this.type_}slice(t,e){if(lu(this.data_)){const r=this.data_,s=SE(r,t,e);return s===null?null:new ge(s)}else{const r=new Uint8Array(this.data_.buffer,t,e-t);return new ge(r,!0)}}static getBlob(...t){if(Oo()){const e=t.map(r=>r instanceof ge?r.data_:r);return new ge(bE.apply(null,e))}else{const e=t.map(a=>ko(a)?PE(te.RAW,a).data:a.data_);let r=0;e.forEach(a=>{r+=a.byteLength});const s=new Uint8Array(r);let o=0;return e.forEach(a=>{for(let u=0;u<a.length;u++)s[o++]=a[u]}),new ge(s,!0)}}uploadData(){return this.data_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const Kh="storage";function sT(n,t,e){return n=Bt(n),JE(n,t,e)}function iT(n){return n=Bt(n),YE(n)}function oT(n,t){return n=Bt(n),nT(n,t)}function aT(n=tl(),t){n=Bt(n);const r=Xu(n,Kh).getImmediate({identifier:t}),s=ju("storage");return s&&cT(r,...s),r}function cT(n,t,e,r={}){rT(n,t,e,r)}function uT(n,{instanceIdentifier:t}){const e=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Mo(e,r,s,t,Yu)}function lT(){Zn(new ln(Kh,uT,"PUBLIC").setMultipleInstances(!0)),Te(fu,pu,""),Te(fu,pu,"esm2020")}lT();function hT(){return{apiKey:"AIzaSyBPDYniKMdsGrESHpBz8OQvE3Jr2dfJDfM",authDomain:"alsaleem-call-center.firebaseapp.com",projectId:"alsaleem-call-center",storageBucket:"alsaleem-call-center.firebasestorage.app",messagingSenderId:"5278467167",appId:"1:5278467167:web:90fced71223e2a5ee6c7ea"}}function dT(n){return n&&n.apiKey&&n.projectId&&n.storageBucket&&n.appId}async function fT(n,t,e){const r=`conversations/${t}/${Date.now()}-${e.name}`,s=oT(n,r);return await sT(s,e),await iT(s)}async function pT(n){const t=new FormData;t.append("file",n);const e=document.querySelector('meta[name="csrf-token"]')?.getAttribute("content"),r=await fetch("/api/upload",{method:"POST",headers:{"X-CSRF-TOKEN":e||""},body:t});if(!r.ok){const o=await r.json().catch(()=>({message:"Upload failed"}));throw new Error(o.message||"Failed to upload file")}return(await r.json()).url}function mT(n){if(!n)return null;const t=n.type;return t.startsWith("audio/")?"voice":t.startsWith("image/")?"image":t.startsWith("video/")?"video":"document"}function gT(n){if(!n)return null;const t=n.toLowerCase();return t.match(/\.(mp3|m4a|aac|wav|ogg|webm)(\?|$)/)?"voice":t.match(/\.(mp4|mov|webm)(\?|$)/)?"video":t.match(/\.(png|jpg|jpeg|gif|webp)(\?|$)/)?"image":"document"}function _T(n){const t=(n||"").toLowerCase();return t.includes(".mp3")?"audio/mpeg":t.includes(".webm")?"audio/webm":t.includes(".ogg")?"audio/ogg":t.includes(".m4a")||t.includes(".aac")?"audio/mp4":t.includes(".wav")?"audio/wav":"audio/*"}function yT(n){const t=n.getAttribute("data-conversation"),e=n.getAttribute("data-title")||"Chat",r=hT();if(!dT(r)){n.innerHTML='<div class="border p-3 bg-yellow-50 rounded">Firebase is not configured. Set VITE_FIREBASE_* in .env.</div>';return}const s=Zu(r),o=Py(s),a=aT(s);n.innerHTML=`
    ...
    `;const u=n.querySelector("#messages"),h=n.querySelector("#textInput"),d=n.querySelector("#fileInput"),f=n.querySelector("#filePreview"),g=n.querySelector("#recordBtn"),w=n.querySelector("#recTimer"),P=n.querySelector("#sendBtn"),v=P?P.textContent:"Send";function V(m){P&&(P.disabled=!!m,P.textContent=m?"Sending…":v,m?P.classList.add("opacity-60","cursor-not-allowed"):P.classList.remove("opacity-60","cursor-not-allowed"))}let b=null,x=null,F=[],L=null,j=null;function J(){f&&(f.innerHTML="",f.classList.add("hidden"))}function tt(m){if(!m||!f)return J();const $=URL.createObjectURL(m);let B="";const K="inline-flex items-center gap-2 px-3 py-2 border rounded bg-gray-50";m.type.startsWith("image/")?B=`<div class="${K}"><img src="${$}" class="h-16 w-auto rounded" /><div class="text-sm">${m.name}</div><button type="button" id="removeFile" class="ml-2 text-red-600 text-sm">Remove</button></div>`:m.type.startsWith("video/")?B=`<div class="${K}"><video src="${$}" class="h-16 w-24" muted loop></video><div class="text-sm">${m.name}</div><button type="button" id="removeFile" class="ml-2 text-red-600 text-sm">Remove</button></div>`:m.type.startsWith("audio/")?B=`<div class="${K}"><audio src="${$}" controls class="h-8"></audio><div class="text-sm">${m.name}</div><button type="button" id="removeFile" class="ml-2 text-red-600 text-sm">Remove</button></div>`:B=`<div class="${K}"><span class="text-sm">${m.name}</span><button type="button" id="removeFile" class="ml-2 text-red-600 text-sm">Remove</button></div>`,f.innerHTML=B,f.classList.remove("hidden");const wt=f.querySelector("#removeFile");wt&&wt.addEventListener("click",()=>{URL.revokeObjectURL($),d.value="",b=null,J()})}d.addEventListener("change",()=>{b=d.files&&d.files[0]||null,tt(b)});function E(){if(!L||!w)return;const m=Math.floor((Date.now()-L)/1e3),$=String(Math.floor(m/60)).padStart(2,"0"),B=String(m%60).padStart(2,"0");w.textContent=`${$}:${B}`}async function _(){try{const m=await navigator.mediaDevices.getUserMedia({audio:!0});F=[];const $=["audio/webm;codecs=opus","audio/webm","audio/ogg;codecs=opus","audio/ogg"];let B="";for(const K of $)if(window.MediaRecorder&&MediaRecorder.isTypeSupported&&MediaRecorder.isTypeSupported(K)){B=K,console.log("Selected audio format:",B);break}if(!B){m.getTracks().forEach(K=>K.stop()),alert("Audio recording is not supported in this browser. Please use a modern browser (Chrome, Firefox, or Edge).");return}x=new MediaRecorder(m,{mimeType:B,audioBitsPerSecond:128e3}),console.log("MediaRecorder mimeType:",x.mimeType),x.ondataavailable=K=>{K.data&&K.data.size>0&&F.push(K.data)},x.onstop=async()=>{await new Promise(it=>setTimeout(it,100));const K=B.includes("webm")?"webm":"ogg",wt=B.includes("webm")?"audio/webm":"audio/ogg";if(B.includes("mp4")||B.includes("m4a")){console.error("ERROR: M4A format detected! This should not happen."),alert("Error: Browser fallback to M4A detected. Please use Chrome, Firefox, or Edge."),m.getTracks().forEach(it=>it.stop());return}console.log("Creating audio file:",{extension:K,mimeType:wt,chunks:F.length,totalSize:F.reduce((it,oe)=>it+oe.size,0)});const nt=new Blob(F,{type:wt});b=new File([nt],`voice-${Date.now()}.${K}`,{type:wt,lastModified:Date.now()}),console.log("Created file:",b.name,b.type),tt(b),m.getTracks().forEach(it=>it.stop())},x.start(),L=Date.now(),w.classList.remove("hidden"),E(),j=setInterval(E,500),g.innerHTML=`
              <svg class="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 10a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4z"></path>
              </svg>`}catch{alert("Microphone permission denied or not available.")}}function y(){x&&x.state!=="inactive"&&x.stop(),j&&clearInterval(j),j=null,w.classList.add("hidden"),g.innerHTML=`
          <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"></path>
          </svg>`}g&&g.addEventListener("click",()=>{!x||x.state==="inactive"?_():y()});const A=Cy(o,"conversations",String(t),"messages"),T=()=>{u&&(u.scrollTop=u.scrollHeight)},I=jy(A,qy("createdAt"));Qy(I,m=>{u.innerHTML="",m.forEach($=>{const B=$.data(),K=B.senderType==="agent",wt=document.createElement("div");wt.className=`flex ${K?"justify-end":"justify-start"}`;const nt=document.createElement("div");nt.className=`max-w-[75%] rounded-2xl px-4 py-2 shadow ${K?"bg-blue-600 text-white rounded-br-md":"bg-gray-100 text-gray-900 rounded-bl-md"}`;let it="";B.body&&(it+=`<div class="whitespace-pre-wrap">${B.body}</div>`,B.edited&&(it+='<div class="text-xs opacity-70 mt-1">(edited)</div>')),K&&(it+=`<div class="mt-2 flex gap-1 justify-end">
                    <button onclick="editMessage('${$.id}', '${B.body?.replace(/'/g,"\\'")||""}')" class="text-xs px-2 py-1 bg-white bg-opacity-20 rounded hover:bg-opacity-30 transition-colors" title="Edit">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                    </button>
                    <button onclick="deleteMessage('${$.id}')" class="text-xs px-2 py-1 bg-white bg-opacity-20 rounded hover:bg-opacity-30 transition-colors" title="Delete">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
                        </svg>
                    </button>
                </div>`);const oe=B.attachment||{},yt=B.attachmentUrl||B.attachment_url||B.attachmentPath||B.attachment_path||B.url||B.fileUrl||B.file_url||oe.url||oe.path||null,xt=B.attachmentType||B.attachment_type||oe.type||gT(yt);if(yt)if(xt==="image")it+=`<img src="${yt}" class="mt-2 rounded-lg max-w-full" />`;else if(xt==="video")it+=`<video src="${yt}" controls preload="metadata" class="mt-2 rounded-lg max-w-full"></video>`;else if(xt==="voice"){const Ht=_T(yt);console.log("audio messages"),it+=`<audio controls style="height: 40px;width: 500px;" preload="metadata" class="mt-2 w-full" controls>
                    <source src="${yt}" type="${Ht}">Your browser does not support the audio element.</audio>`}else it+=`<a class="mt-2 underline block" href="${yt}" target="_blank">Attachment</a>`;else xt==="voice"&&(it+='<div class="mt-1 italic opacity-80">Voice message (no URL)</div>');nt.innerHTML=it,wt.appendChild(nt),u.appendChild(wt);const Qt=nt.querySelector("img,video");Qt&&(Qt.addEventListener("load",()=>setTimeout(T,10),{once:!0}),Qt.addEventListener("loadeddata",()=>setTimeout(T,10),{once:!0}))}),T(),setTimeout(T,50)}),P.addEventListener("click",async()=>{const m=h.value.trim(),$=b||d.files&&d.files[0];if(!m&&!$)return;let B=null,K=null,wt=m;V(!0);try{if($){const nt=mT($);nt==="image"||nt==="voice"?(B=await pT($),K=nt):(B=await fT(a,t,$),K=nt)}await Wy(A,{body:wt||null,attachmentUrl:B,attachmentType:K,senderType:"agent",createdAt:uu()});try{await fetch(`/api/activity/conversation/${t}`,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":document.querySelector('meta[name="csrf-token"]').getAttribute("content")},body:JSON.stringify({body:wt,sender_type:"agent"})})}catch{}h.value="",d.value&&(d.value=""),b=null,J(),T()}catch(nt){console.error("Failed to send message",nt),alert("Failed to send message. Please try again.")}finally{V(!1)}}),window.editMessage=async function(m,$){const B=prompt("Edit message:",$);if(B!==null&&B!==$)try{const K=Bi(o,"conversations",t,"messages",m);await Gy(K,{body:B,edited:!0,editedAt:uu()})}catch(K){console.error("Error editing message:",K),alert("Failed to edit message")}},window.deleteMessage=async function(m){if(confirm("Are you sure you want to delete this message?"))try{const $=Bi(o,"conversations",t,"messages",m);await Ky($)}catch($){console.error("Error deleting message:",$),alert("Failed to delete message")}}}document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("chat-app");n&&yT(n)});
