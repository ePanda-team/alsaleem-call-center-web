 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gp="FirebaseError";class Ke extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=gp,Object.setPrototypeOf(this,Ke.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Gu.prototype.create)}}class Gu{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){const r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],a=o?_p(o,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new Ke(s,u,r)}}function _p(n,t){return n.replace(yp,(e,r)=>{const s=t[r];return s!=null?String(s):`<${r}?>`})}const yp=/\{\$([^}]+)}/g;function Jr(n,t){if(n===t)return!0;const e=Object.keys(n),r=Object.keys(t);for(const s of e){if(!r.includes(s))return!1;const o=n[s],a=t[s];if(Za(o)&&Za(a)){if(!Jr(o,a))return!1}else if(o!==a)return!1}for(const s of r)if(!e.includes(s))return!1;return!0}function Za(n){return n!==null&&typeof n=="object"}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oe=new Wu("@firebase/app"),Bp="@firebase/app-compat",jp="@firebase/analytics-compat",qp="@firebase/analytics",$p="@firebase/app-check-compat",zp="@firebase/app-check",Hp="@firebase/auth",Gp="@firebase/auth-compat",Wp="@firebase/database",Kp="@firebase/data-connect",Qp="@firebase/database-compat",Xp="@firebase/functions",Jp="@firebase/functions-compat",Yp="@firebase/installations",Zp="@firebase/installations-compat",tm="@firebase/messaging",em="@firebase/messaging-compat",nm="@firebase/performance",rm="@firebase/performance-compat",sm="@firebase/remote-config",im="@firebase/remote-config-compat",om="@firebase/storage",am="@firebase/storage-compat",cm="@firebase/firestore",um="@firebase/ai",lm="@firebase/firestore-compat",hm="firebase",dm="12.3.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wi="[DEFAULT]",fm={[Ti]:"fire-core",[Bp]:"fire-core-compat",[qp]:"fire-analytics",[jp]:"fire-analytics-compat",[zp]:"fire-app-check",[$p]:"fire-app-check-compat",[Hp]:"fire-auth",[Gp]:"fire-auth-compat",[Wp]:"fire-rtdb",[Kp]:"fire-data-connect",[Qp]:"fire-rtdb-compat",[Xp]:"fire-fn",[Jp]:"fire-fn-compat",[Yp]:"fire-iid",[Zp]:"fire-iid-compat",[tm]:"fire-fcm",[em]:"fire-fcm-compat",[nm]:"fire-perf",[rm]:"fire-perf-compat",[sm]:"fire-rc",[im]:"fire-rc-compat",[om]:"fire-gcs",[am]:"fire-gcs-compat",[cm]:"fire-fst",[lm]:"fire-fst-compat",[um]:"fire-vertex","fire-js":"fire-js",[hm]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const He=new Wu("@firebase/firestore");function nn(){return He.logLevel}function M(n,...t){if(He.logLevel<=Z.DEBUG){const e=t.map(Ki);He.debug(`Firestore (${Tn}): ${n}`,...e)}}function ae(n,...t){if(He.logLevel<=Z.ERROR){const e=t.map(Ki);He.error(`Firestore (${Tn}): ${n}`,...e)}}function hn(n,...t){if(He.logLevel<=Z.WARN){const e=t.map(Ki);He.warn(`Firestore (${Tn}): ${n}`,...e)}}function Ki(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fl="";function Wm(n){let t="";for(let e=0;e<n.length;e++)t.length>0&&(t=_c(t)),t=Km(n.get(e),t);return _c(t)}function Km(n,t){let e=t;const r=n.length;for(let s=0;s<r;s++){const o=n.charAt(s);switch(o){case"\0":e+="";break;case fl:e+="";break;default:e+=o}}return e}function _c(n){return n+fl+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yt{constructor(t){this.comparator=t,this.data=new ot(this.comparator)}has(t){return this.data.get(t)!==null}first(){return this.data.minKey()}last(){return this.data.maxKey()}get size(){return this.data.size}indexOf(t){return this.data.indexOf(t)}forEach(t){this.data.inorderTraversal(((e,r)=>(t(e),!1)))}forEachInRange(t,e){const r=this.data.getIteratorFrom(t[0]);for(;r.hasNext();){const s=r.getNext();if(this.comparator(s.key,t[1])>=0)return;e(s.key)}}forEachWhile(t,e){let r;for(r=e!==void 0?this.data.getIteratorFrom(e):this.data.getIterator();r.hasNext();)if(!t(r.getNext().key))return}firstAfterOrEqual(t){const e=this.data.getIteratorFrom(t);return e.hasNext()?e.getNext().key:null}getIterator(){return new Ec(this.data.getIterator())}getIteratorFrom(t){return new Ec(this.data.getIteratorFrom(t))}add(t){return this.copy(this.data.remove(t).insert(t,!0))}delete(t){return this.has(t)?this.copy(this.data.remove(t)):this}isEmpty(){return this.data.isEmpty()}unionWith(t){let e=this;return e.size<t.size&&(e=t,t=this),t.forEach((r=>{e=e.add(r)})),e}isEqual(t){if(!(t instanceof yt)||this.size!==t.size)return!1;const e=this.data.getIterator(),r=t.data.getIterator();for(;e.hasNext();){const s=e.getNext().key,o=r.getNext().key;if(this.comparator(s,o)!==0)return!1}return!0}toArray(){const t=[];return this.forEach((e=>{t.push(e)})),t}toString(){const t=[];return this.forEach((e=>t.push(e))),"SortedSet("+t.toString()+")"}copy(t){const e=new yt(this.comparator);return e.data=t,e}}class Ec{constructor(t){this.iter=t}getNext(){return this.iter.getNext().key}hasNext(){return this.iter.hasNext()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qt{constructor(t){this.fields=t,t.sort(vt.comparator)}static empty(){return new qt([])}unionWith(t){let e=new yt(vt.comparator);for(const r of this.fields)e=e.add(r);for(const r of t)e=e.add(r);return new qt(e.toArray())}covers(t){for(const e of this.fields)if(e.isPrefixOf(t))return!0;return!1}isEqual(t){return dn(this.fields,t.fields,((e,r)=>e.isEqual(r)))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rt{constructor(t){this.binaryString=t}static fromBase64String(t){const e=(function(s){try{return atob(s)}catch(o){throw typeof DOMException<"u"&&o instanceof DOMException?new ml("Invalid base64 string: "+o):o}})(t);return new Rt(e)}static fromUint8Array(t){const e=(function(s){let o="";for(let a=0;a<s.length;++a)o+=String.fromCharCode(s[a]);return o})(t);return new Rt(e)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return(function(e){return btoa(e)})(this.binaryString)}toUint8Array(){return(function(e){const r=new Uint8Array(e.length);for(let s=0;s<e.length;s++)r[s]=e.charCodeAt(s);return r})(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return Q(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}Rt.EMPTY_BYTE_STRING=new Rt("");const Qm=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function ve(n){if(et(!!n,39018),typeof n=="string"){let t=0;const e=Qm.exec(n);if(et(!!e,46558,{timestamp:n}),e[1]){let s=e[1];s=(s+"000000000").substr(0,9),t=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:t}}return{seconds:lt(n.seconds),nanos:lt(n.nanos)}}function lt(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function Re(n){return typeof n=="string"?Rt.fromBase64String(n):Rt.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gl="server_timestamp",_l="__type__",yl="__previous_value__",El="__local_write_time__";function Ji(n){return(n?.mapValue?.fields||{})[_l]?.stringValue===gl}function _s(n){const t=n.mapValue.fields[yl];return Ji(t)?_s(t):t}function nr(n){const t=ve(n.mapValue.fields[El].timestampValue);return new it(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt{constructor(t){this.value=t}static empty(){return new Lt({mapValue:{}})}field(t){if(t.isEmpty())return this.value;{let e=this.value;for(let r=0;r<t.length-1;++r)if(e=(e.mapValue.fields||{})[t.get(r)],!Hr(e))return null;return e=(e.mapValue.fields||{})[t.lastSegment()],e||null}}set(t,e){this.getFieldsMap(t.popLast())[t.lastSegment()]=Kn(e)}setAll(t){let e=vt.emptyPath(),r={},s=[];t.forEach(((a,u)=>{if(!e.isImmediateParentOf(u)){const h=this.getFieldsMap(e);this.applyChanges(h,r,s),r={},s=[],e=u.popLast()}a?r[u.lastSegment()]=Kn(a):s.push(u.lastSegment())}));const o=this.getFieldsMap(e);this.applyChanges(o,r,s)}delete(t){const e=this.field(t.popLast());Hr(e)&&e.mapValue.fields&&delete e.mapValue.fields[t.lastSegment()]}isEqual(t){return ie(this.value,t.value)}getFieldsMap(t){let e=this.value;e.mapValue.fields||(e.mapValue={fields:{}});for(let r=0;r<t.length;++r){let s=e.mapValue.fields[t.get(r)];Hr(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},e.mapValue.fields[t.get(r)]=s),e=s}return e.mapValue.fields}applyChanges(t,e,r){Pe(e,((s,o)=>t[s]=o));for(const s of r)delete t[s]}clone(){return new Lt(Kn(this.value))}}function Al(n){const t=[];return Pe(n.fields,((e,r)=>{const s=new vt([e]);if(Hr(r)){const o=Al(r.mapValue).fields;if(o.length===0)t.push(s);else for(const a of o)t.push(s.child(a))}else t.push(s)})),new qt(t)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Il{}class ft extends Il{constructor(t,e,r){super(),this.field=t,this.op=e,this.value=r}static create(t,e,r){return t.isKeyField()?e==="in"||e==="not-in"?this.createKeyFieldInFilter(t,e,r):new ng(t,e,r):e==="array-contains"?new ig(t,r):e==="in"?new og(t,r):e==="not-in"?new ag(t,r):e==="array-contains-any"?new cg(t,r):new ft(t,e,r)}static createKeyFieldInFilter(t,e,r){return e==="in"?new rg(t,r):new sg(t,r)}matches(t){const e=t.data.field(this.field);return this.op==="!="?e!==null&&e.nullValue===void 0&&this.matchesComparison(fn(e,this.value)):e!==null&&be(this.value)===be(e)&&this.matchesComparison(fn(e,this.value))}matchesComparison(t){switch(this.op){case"<":return t<0;case"<=":return t<=0;case"==":return t===0;case"!=":return t!==0;case">":return t>0;case">=":return t>=0;default:return j(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Wt extends Il{constructor(t,e){super(),this.filters=t,this.op=e,this.Pe=null}static create(t,e){return new Wt(t,e)}matches(t){return vl(this)?this.filters.find((e=>!e.matches(t)))===void 0:this.filters.find((e=>e.matches(t)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((t,e)=>t.concat(e.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function vl(n){return n.op==="and"}function Rl(n){return eg(n)&&vl(n)}function eg(n){for(const t of n.filters)if(t instanceof Wt)return!1;return!0}function Si(n){if(n instanceof ft)return n.field.canonicalString()+n.op.toString()+pn(n.value);if(Rl(n))return n.filters.map((t=>Si(t))).join(",");{const t=n.filters.map((e=>Si(e))).join(",");return`${n.op}(${t})`}}function bl(n,t){return n instanceof ft?(function(r,s){return s instanceof ft&&r.op===s.op&&r.field.isEqual(s.field)&&ie(r.value,s.value)})(n,t):n instanceof Wt?(function(r,s){return s instanceof Wt&&r.op===s.op&&r.filters.length===s.filters.length?r.filters.reduce(((o,a,u)=>o&&bl(a,s.filters[u])),!0):!1})(n,t):void j(19439)}function Sl(n){return n instanceof ft?(function(e){return`${e.field.canonicalString()} ${e.op} ${pn(e.value)}`})(n):n instanceof Wt?(function(e){return e.op.toString()+" {"+e.getFilters().map(Sl).join(" ,")+"}"})(n):"Filter"}class ng extends ft{constructor(t,e,r){super(t,e,r),this.key=U.fromName(r.referenceValue)}matches(t){const e=U.comparator(t.key,this.key);return this.matchesComparison(e)}}class rg extends ft{constructor(t,e){super(t,"in",e),this.keys=Cl("in",e)}matches(t){return this.keys.some((e=>e.isEqual(t.key)))}}class sg extends ft{constructor(t,e){super(t,"not-in",e),this.keys=Cl("not-in",e)}matches(t){return!this.keys.some((e=>e.isEqual(t.key)))}}function Cl(n,t){return(t.arrayValue?.values||[]).map((e=>U.fromName(e.referenceValue)))}class ig extends ft{constructor(t,e){super(t,"array-contains",e)}matches(t){const e=t.data.field(this.field);return Yi(e)&&sr(e.arrayValue,this.value)}}class og extends ft{constructor(t,e){super(t,"in",e)}matches(t){const e=t.data.field(this.field);return e!==null&&sr(this.value.arrayValue,e)}}class ag extends ft{constructor(t,e){super(t,"not-in",e)}matches(t){if(sr(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const e=t.data.field(this.field);return e!==null&&e.nullValue===void 0&&!sr(this.value.arrayValue,e)}}class cg extends ft{constructor(t,e){super(t,"array-contains-any",e)}matches(t){const e=t.data.field(this.field);return!(!Yi(e)||!e.arrayValue.values)&&e.arrayValue.values.some((r=>sr(this.value.arrayValue,r)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class As{constructor(t,e,r,s,o){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=r,this.documentUpdates=s,this.resolvedLimboDocuments=o}static createSynthesizedRemoteEventForCurrentChange(t,e,r){const s=new Map;return s.set(t,gr.createSynthesizedTargetChangeForCurrentChange(t,e,r)),new As(z.min(),s,new ot(Q),ce(),X())}}class gr{constructor(t,e,r,s,o){this.resumeToken=t,this.current=e,this.addedDocuments=r,this.modifiedDocuments=s,this.removedDocuments=o}static createSynthesizedTargetChangeForCurrentChange(t,e,r){return new gr(r,e,X(),X(),X())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class d_{constructor(){this.sessionToken=Rt.EMPTY_BYTE_STRING}getSessionToken(t){return N.resolve(this.sessionToken)}setSessionToken(t,e){return this.sessionToken=e,N.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{constructor(){this.Qr=new yt(wt.$r),this.Ur=new yt(wt.Kr)}isEmpty(){return this.Qr.isEmpty()}addReference(t,e){const r=new wt(t,e);this.Qr=this.Qr.add(r),this.Ur=this.Ur.add(r)}Wr(t,e){t.forEach((r=>this.addReference(r,e)))}removeReference(t,e){this.Gr(new wt(t,e))}zr(t,e){t.forEach((r=>this.removeReference(r,e)))}jr(t){const e=new U(new rt([])),r=new wt(e,t),s=new wt(e,t+1),o=[];return this.Ur.forEachInRange([r,s],(a=>{this.Gr(a),o.push(a.key)})),o}Jr(){this.Qr.forEach((t=>this.Gr(t)))}Gr(t){this.Qr=this.Qr.delete(t),this.Ur=this.Ur.delete(t)}Hr(t){const e=new U(new rt([])),r=new wt(e,t),s=new wt(e,t+1);let o=X();return this.Ur.forEachInRange([r,s],(a=>{o=o.add(a.key)})),o}containsKey(t){const e=new wt(t,0),r=this.Qr.firstAfterOrEqual(e);return r!==null&&t.isEqual(r.key)}}class wt{constructor(t,e){this.key=t,this.Yr=e}static $r(t,e){return U.comparator(t.key,e.key)||Q(t.Yr,e.Yr)}static Kr(t,e){return Q(t.Yr,e.Yr)||U.comparator(t.key,e.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class f_{constructor(t,e){this.indexManager=t,this.referenceDelegate=e,this.mutationQueue=[],this.tr=1,this.Zr=new yt(wt.$r)}checkEmpty(t){return N.resolve(this.mutationQueue.length===0)}addMutationBatch(t,e,r,s){const o=this.tr;this.tr++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const a=new Cg(o,e,r,s);this.mutationQueue.push(a);for(const u of s)this.Zr=this.Zr.add(new wt(u.key,o)),this.indexManager.addToCollectionParentIndex(t,u.key.path.popLast());return N.resolve(a)}lookupMutationBatch(t,e){return N.resolve(this.Xr(e))}getNextMutationBatchAfterBatchId(t,e){const r=e+1,s=this.ei(r),o=s<0?0:s;return N.resolve(this.mutationQueue.length>o?this.mutationQueue[o]:null)}getHighestUnacknowledgedBatchId(){return N.resolve(this.mutationQueue.length===0?Xi:this.tr-1)}getAllMutationBatches(t){return N.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(t,e){const r=new wt(e,0),s=new wt(e,Number.POSITIVE_INFINITY),o=[];return this.Zr.forEachInRange([r,s],(a=>{const u=this.Xr(a.Yr);o.push(u)})),N.resolve(o)}getAllMutationBatchesAffectingDocumentKeys(t,e){let r=new yt(Q);return e.forEach((s=>{const o=new wt(s,0),a=new wt(s,Number.POSITIVE_INFINITY);this.Zr.forEachInRange([o,a],(u=>{r=r.add(u.Yr)}))})),N.resolve(this.ti(r))}getAllMutationBatchesAffectingQuery(t,e){const r=e.path,s=r.length+1;let o=r;U.isDocumentKey(o)||(o=o.child(""));const a=new wt(new U(o),0);let u=new yt(Q);return this.Zr.forEachWhile((h=>{const d=h.key.path;return!!r.isPrefixOf(d)&&(d.length===s&&(u=u.add(h.Yr)),!0)}),a),N.resolve(this.ti(u))}ti(t){const e=[];return t.forEach((r=>{const s=this.Xr(r);s!==null&&e.push(s)})),e}removeMutationBatch(t,e){et(this.ni(e.batchId,"removed")===0,55003),this.mutationQueue.shift();let r=this.Zr;return N.forEach(e.mutations,(s=>{const o=new wt(s.key,e.batchId);return r=r.delete(o),this.referenceDelegate.markPotentiallyOrphaned(t,s.key)})).next((()=>{this.Zr=r}))}ir(t){}containsKey(t,e){const r=new wt(e,0),s=this.Zr.firstAfterOrEqual(r);return N.resolve(e.isEqual(s&&s.key))}performConsistencyCheck(t){return this.mutationQueue.length,N.resolve()}ni(t,e){return this.ei(t)}ei(t){return this.mutationQueue.length===0?0:t-this.mutationQueue[0].batchId}Xr(t){const e=this.ei(t);return e<0||e>=this.mutationQueue.length?null:this.mutationQueue[e]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Je{constructor(t,e,r){this.converter=e,this._query=r,this.type="query",this.firestore=t}withConverter(t){return new Je(this.firestore,t,this._query)}}class mt{constructor(t,e,r){this.converter=e,this._key=r,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Ae(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new mt(this.firestore,t,this._key)}toJSON(){return{type:mt._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(t,e,r){if(pr(e,mt._jsonSchema))return new mt(t,r||null,new U(rt.fromString(e.referencePath)))}}mt._jsonSchemaVersion="firestore/documentReference/1.0",mt._jsonSchema={type:pt("string",mt._jsonSchemaVersion),referencePath:pt("string")};class Ae extends Je{constructor(t,e,r){super(t,e,eo(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new mt(this.firestore,null,new U(t))}withConverter(t){return new Ae(this.firestore,t,this._path)}}function Cy(n,t,...e){if(n=Bt(n),hl("collection","path",t),n instanceof bs){const r=rt.fromString(t,...e);return pc(r),new Ae(n,null,r)}{if(!(n instanceof mt||n instanceof Ae))throw new O(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(rt.fromString(t,...e));return pc(r),new Ae(n.firestore,null,r)}}function Bi(n,t,...e){if(n=Bt(n),arguments.length===1&&(t=Qi.newId()),hl("doc","path",t),n instanceof bs){const r=rt.fromString(t,...e);return fc(r),new mt(n,null,new U(r))}{if(!(n instanceof mt||n instanceof Ae))throw new O(D.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(rt.fromString(t,...e));return fc(r),new mt(n.firestore,n instanceof Ae?n.converter:null,new U(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zt{constructor(t){this._byteString=t}static fromBase64String(t){try{return new zt(Rt.fromBase64String(t))}catch(e){throw new O(D.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(t){return new zt(Rt.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}toJSON(){return{type:zt._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(t){if(pr(t,zt._jsonSchema))return zt.fromBase64String(t.bytes)}}zt._jsonSchemaVersion="firestore/bytes/1.0",zt._jsonSchema={type:pt("string",zt._jsonSchemaVersion),bytes:pt("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new O(D.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new vt(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut extends Ke{constructor(t,e,r=0){super(hi(t),`Firebase Storage: ${e} (${hi(t)})`),this.status_=r,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,ut.prototype)}get status(){return this.status_}set status(t){this.status_=t}_codeEquals(t){return hi(t)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(t){this.customData.serverResponse=t,this.customData.serverResponse?this.message=`${this._baseMessage}
${this.customData.serverResponse}`:this.message=this._baseMessage}}var ct;(function(n){n.UNKNOWN="unknown",n.OBJECT_NOT_FOUND="object-not-found",n.BUCKET_NOT_FOUND="bucket-not-found",n.PROJECT_NOT_FOUND="project-not-found",n.QUOTA_EXCEEDED="quota-exceeded",n.UNAUTHENTICATED="unauthenticated",n.UNAUTHORIZED="unauthorized",n.UNAUTHORIZED_APP="unauthorized-app",n.RETRY_LIMIT_EXCEEDED="retry-limit-exceeded",n.INVALID_CHECKSUM="invalid-checksum",n.CANCELED="canceled",n.INVALID_EVENT_NAME="invalid-event-name",n.INVALID_URL="invalid-url",n.INVALID_DEFAULT_BUCKET="invalid-default-bucket",n.NO_DEFAULT_BUCKET="no-default-bucket",n.CANNOT_SLICE_BLOB="cannot-slice-blob",n.SERVER_FILE_WRONG_SIZE="server-file-wrong-size",n.NO_DOWNLOAD_URL="no-download-url",n.INVALID_ARGUMENT="invalid-argument",n.INVALID_ARGUMENT_COUNT="invalid-argument-count",n.APP_DELETED="app-deleted",n.INVALID_ROOT_OPERATION="invalid-root-operation",n.INVALID_FORMAT="invalid-format",n.INTERNAL_ERROR="internal-error",n.UNSUPPORTED_ENVIRONMENT="unsupported-environment"})(ct||(ct={}));function hi(n){return"storage/"+n}function No(){const n="An unknown error occurred, please check the error payload for server response.";return new ut(ct.UNKNOWN,n)}function Zy(n){return new ut(ct.OBJECT_NOT_FOUND,"Object '"+n+"' does not exist.")}function tE(n){return new ut(ct.QUOTA_EXCEEDED,"Quota for bucket '"+n+"' exceeded, please view quota on https://firebase.google.com/pricing/.")}function eE(){const n="User is not authenticated, please authenticate using Firebase Authentication and try again.";return new ut(ct.UNAUTHENTICATED,n)}function nE(){return new ut(ct.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project.")}function rE(n){return new ut(ct.UNAUTHORIZED,"User does not have permission to access '"+n+"'.")}function sE(){return new ut(ct.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function iE(){return new ut(ct.CANCELED,"User canceled the upload/download.")}function oE(n){return new ut(ct.INVALID_URL,"Invalid URL '"+n+"'.")}function aE(n){return new ut(ct.INVALID_DEFAULT_BUCKET,"Invalid default bucket '"+n+"'.")}function cE(){return new ut(ct.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+Nh+"' property when initializing the app?")}function uE(){return new ut(ct.CANNOT_SLICE_BLOB,"Cannot slice blob for upload. Please retry the upload.")}function lE(){return new ut(ct.NO_DOWNLOAD_URL,"The given file does not have any download URLs.")}function hE(n){return new ut(ct.UNSUPPORTED_ENVIRONMENT,`${n} is missing. Make sure to install the required polyfills. See https://firebase.google.com/docs/web/environments-js-sdk#polyfills for more information.`)}function qi(n){return new ut(ct.INVALID_ARGUMENT,n)}function kh(){return new ut(ct.APP_DELETED,"The Firebase app was deleted.")}function dE(n){return new ut(ct.INVALID_ROOT_OPERATION,"The operation '"+n+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}function Yn(n,t){return new ut(ct.INVALID_FORMAT,"String does not match format '"+n+"': "+t)}function qn(n){throw new ut(ct.INTERNAL_ERROR,"Internal error: "+n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{constructor(t,e){this._service=t,e instanceof $t?this._location=e:this._location=$t.makeFromUrl(e,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,e){return new We(t,e)}get root(){const t=new $t(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Uh(this._location.path)}get storage(){return this._service}get parent(){const t=OE(this._location.path);if(t===null)return null;const e=new $t(this._location.bucket,t);return new We(this._service,e)}_throwIfRoot(t){if(this._location.path==="")throw dE(t)}}function JE(n,t,e){n._throwIfRoot("uploadBytes");const r=KE(n.storage,n._location,Bh(),new me(t,!0),e);return n.storage.makeRequestWithTokens(r,Hh).then(s=>({metadata:s,ref:n}))}function YE(n){n._throwIfRoot("getDownloadURL");const t=HE(n.storage,n._location,Bh());return n.storage.makeRequestWithTokens(t,Hh).then(e=>{if(e===null)throw lE();return e})}function ZE(n,t){const e=xE(n._location.path,t),r=new $t(n._location.bucket,e);return new We(n.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wh="storage";function sT(n,t,e){return n=Bt(n),JE(n,t,e)}function iT(n){return n=Bt(n),YE(n)}function oT(n,t){return n=Bt(n),nT(n,t)}function aT(n=tl(),t){n=Bt(n);const r=Xu(n,Wh).getImmediate({identifier:t}),s=ju("storage");return s&&cT(r,...s),r}function cT(n,t,e,r={}){rT(n,t,e,r)}function uT(n,{instanceIdentifier:t}){const e=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Mo(e,r,s,t,Yu)}function lT(){Zn(new ln(Wh,uT,"PUBLIC").setMultipleInstances(!0)),Ee(fu,pu,""),Ee(fu,pu,"esm2020")}lT();function hT(){return{apiKey:"AIzaSyBPDYniKMdsGrESHpBz8OQvE3Jr2dfJDfM",authDomain:"alsaleem-call-center.firebaseapp.com",projectId:"alsaleem-call-center",storageBucket:"alsaleem-call-center.firebasestorage.app",messagingSenderId:"5278467167",appId:"1:5278467167:web:90fced71223e2a5ee6c7ea"}}function dT(n){return n&&n.apiKey&&n.projectId&&n.storageBucket&&n.appId}async function fT(n,t,e){const r=`conversations/${t}/${Date.now()}-${e.name}`,s=oT(n,r);return await sT(s,e),await iT(s)}function pT(n){if(!n)return null;const t=n.type;return t.startsWith("audio/")?"voice":t.startsWith("image/")?"image":t.startsWith("video/")?"video":"document"}function mT(n){if(!n)return null;const t=n.toLowerCase();return t.match(/\.(mp3|m4a|aac|wav|ogg|webm)(\?|$)/)?"voice":t.match(/\.(mp4|mov|webm)(\?|$)/)?"video":t.match(/\.(png|jpg|jpeg|gif|webp)(\?|$)/)?"image":"document"}function gT(n){const t=(n||"").toLowerCase();return t.includes(".mp3")?"audio/mpeg":t.includes(".m4a")||t.includes(".aac")?"audio/mp4":t.includes(".wav")?"audio/wav":t.includes(".ogg")?"audio/ogg":t.includes(".webm")?"audio/webm":"audio/*"}function _T(n){const t=n.getAttribute("data-conversation"),e=n.getAttribute("data-title")||"Chat",r=hT();if(!dT(r)){n.innerHTML='<div class="border p-3 bg-yellow-50 rounded">Firebase is not configured. Set VITE_FIREBASE_* in .env.</div>';return}const s=Zu(r),o=Py(s),a=aT(s);n.innerHTML=`
    ...
    `;const u=n.querySelector("#messages"),h=n.querySelector("#textInput"),d=n.querySelector("#fileInput"),f=n.querySelector("#filePreview"),g=n.querySelector("#recordBtn"),w=n.querySelector("#recTimer"),P=n.querySelector("#sendBtn"),v=P?P.textContent:"Send";function V(m){P&&(P.disabled=!!m,P.textContent=m?"Sending…":v,m?P.classList.add("opacity-60","cursor-not-allowed"):P.classList.remove("opacity-60","cursor-not-allowed"))}let b=null,x=null,F=[],L=null,B=null;function J(){f&&(f.innerHTML="",f.classList.add("hidden"))}function tt(m){if(!m||!f)return J();const q=URL.createObjectURL(m);let $="";const K="inline-flex items-center gap-2 px-3 py-2 border rounded bg-gray-50";m.type.startsWith("image/")?$=`<div class="${K}"><img src="${q}" class="h-16 w-auto rounded" /><div class="text-sm">${m.name}</div><button type="button" id="removeFile" class="ml-2 text-red-600 text-sm">Remove</button></div>`:m.type.startsWith("video/")?$=`<div class="${K}"><video src="${q}" class="h-16 w-24" muted loop></video><div class="text-sm">${m.name}</div><button type="button" id="removeFile" class="ml-2 text-red-600 text-sm">Remove</button></div>`:m.type.startsWith("audio/")?$=`<div class="${K}"><audio src="${q}" controls class="h-8"></audio><div class="text-sm">${m.name}</div><button type="button" id="removeFile" class="ml-2 text-red-600 text-sm">Remove</button></div>`:$=`<div class="${K}"><span class="text-sm">${m.name}</span><button type="button" id="removeFile" class="ml-2 text-red-600 text-sm">Remove</button></div>`,f.innerHTML=$,f.classList.remove("hidden");const bt=f.querySelector("#removeFile");bt&&bt.addEventListener("click",()=>{URL.revokeObjectURL(q),d.value="",b=null,J()})}d.addEventListener("change",()=>{b=d.files&&d.files[0]||null,tt(b)});function E(){if(!L||!w)return;const m=Math.floor((Date.now()-L)/1e3),q=String(Math.floor(m/60)).padStart(2,"0"),$=String(m%60).padStart(2,"0");w.textContent=`${q}:${$}`}async function _(){try{const m=await navigator.mediaDevices.getUserMedia({audio:!0});F=[];const q=["audio/mp4;codecs=mp4a","audio/mp4"];let $="";for(const K of q)if(window.MediaRecorder&&MediaRecorder.isTypeSupported&&MediaRecorder.isTypeSupported(K)){$=K;break}if(!$){m.getTracks().forEach(K=>K.stop()),alert("M4A audio recording is not supported in this browser. Please use a modern browser that supports MP4/AAC recording.");return}x=new MediaRecorder(m,{mimeType:$}),x.ondataavailable=K=>{K.data&&K.data.size>0&&F.push(K.data)},x.onstop=()=>{const K=new Blob(F,{type:"audio/mp4"});b=new File([K],`voice-${Date.now()}.m4a`,{type:"audio/mp4"}),tt(b),m.getTracks().forEach(bt=>bt.stop())},x.start(),L=Date.now(),w.classList.remove("hidden"),E(),B=setInterval(E,500),g.innerHTML=`
          ...
          <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z"></path>
          </svg>`}g&&g.addEventListener("click",()=>{!x||x.state==="inactive"?_():y()});const A=Cy(o,"conversations",String(t),"messages"),T=()=>{u&&(u.scrollTop=u.scrollHeight)},I=jy(A,qy("createdAt"));Qy(I,m=>{u.innerHTML="",m.forEach(q=>{const $=q.data(),K=$.senderType==="agent",bt=document.createElement("div");bt.className=`flex ${K?"justify-end":"justify-start"}`;const Et=document.createElement("div");Et.className=`max-w-[75%] rounded-2xl px-4 py-2 shadow ${K?"bg-blue-600 text-white rounded-br-md":"bg-gray-100 text-gray-900 rounded-bl-md"}`;let At="";$.body&&(At+=`<div class="whitespace-pre-wrap">${$.body}</div>`,$.edited&&(At+='<div class="text-xs opacity-70 mt-1">(edited)</div>')),K&&(At+=`<div class="mt-2 flex gap-1 justify-end">
                ...
                </div>`);const De=$.attachment||{},gt=$.attachmentUrl||$.attachment_url||$.attachmentPath||$.attachment_path||$.url||$.fileUrl||$.file_url||De.url||De.path||null,xt=$.attachmentType||$.attachment_type||De.type||mT(gt);if(gt)if(xt==="image")At+=`<img src="${gt}" class="mt-2 rounded-lg max-w-full" />`;else if(xt==="video")At+=`<video src="${gt}" controls preload="metadata" class="mt-2 rounded-lg max-w-full"></video>`;else if(xt==="voice"){const Ht=gT(gt);console.log("audio messages"),At+=`<audio controls style="height: 40px;width: 500px;" preload="metadata" class="mt-2 w-full" controls>
                    <source src="${gt}" type="${Ht}">Your browser does not support the audio element.</audio>`}else At+=`<a class="mt-2 underline block" href="${gt}" target="_blank">Attachment</a>`;else xt==="voice"&&(At+='<div class="mt-1 italic opacity-80">Voice message (no URL)</div>');Et.innerHTML=At,bt.appendChild(Et),u.appendChild(bt);const Qt=Et.querySelector("img,video");Qt&&(Qt.addEventListener("load",()=>setTimeout(T,10),{once:!0}),Qt.addEventListener("loadeddata",()=>setTimeout(T,10),{once:!0}))}),T(),setTimeout(T,50)}),P.addEventListener("click",async()=>{const m=h.value.trim(),q=b||d.files&&d.files[0];if(!m&&!q)return;let $=null,K=null;V(!0);try{q&&($=await fT(a,t,q),K=pT(q)),await Ky(A,{body:m||null,attachmentUrl:$,attachmentType:K,senderType:"agent",createdAt:uu()});try{await fetch(`/api/activity/conversation/${t}`,{method:"POST",headers:{"Content-Type":"application/json","X-CSRF-TOKEN":document.querySelector('meta[name="csrf-token"]').getAttribute("content")},body:JSON.stringify({body:m,sender_type:"agent"})})}catch{}h.value="",d.value&&(d.value=""),b=null,J(),T()}catch(bt){console.error("Failed to send message",bt),alert("Failed to send message. Please try again.")}finally{V(!1)}}),window.editMessage=async function(m,q){const $=prompt("Edit message:",q);if($!==null&&$!==q)try{const K=Bi(o,"conversations",t,"messages",m);await Gy(K,{body:$,edited:!0,editedAt:uu()})}catch(K){console.error("Error editing message:",K),alert("Failed to edit message")}},window.deleteMessage=async function(m){if(confirm("Are you sure you want to delete this message?"))try{const q=Bi(o,"conversations",t,"messages",m);await Wy(q)}catch(q){console.error("Error deleting message:",q),alert("Failed to delete message")}}}document.addEventListener("DOMContentLoaded",()=>{const n=document.getElementById("chat-app");n&&_T(n)});
